...
const sc_lv<4> example::ap_ST_fsm_state2 = "10";
const sc_lv<4> example::ap_ST_fsm_state3 = "100";
const sc_lv<4> example::ap_ST_fsm_state4 = "1000";
...
const sc_lv<2> example::ap_const_lv2_2 = "10";
const sc_lv<2> example::ap_const_lv2_3 = "11";
const sc_lv<2> example::ap_const_lv2_1 = "1";
...
void example::thread_ap_clk_no_reset_() {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read()) && 
         esl_seteq<1,1,1>(B_1_ack_in.read(), ap_const_logic_1))) {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && esl_seteq<1,1,1>(B_1_ack_in.read(), ap_const_logic_1))) {
        i_1_reg_84 = i_1_fu_68_p2.read();
    }
}

void example::thread_A_0_ack_in() {
    A_0_ack_in = A_0_state.read()[1];
}

void example::thread_A_0_ack_out() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read()) && 
         !(esl_seteq<1,1,1>(ap_const_logic_0, B_1_ack_in.read()) || esl_seteq<1,1,1>(ap_const_logic_0, A_0_vld_out.read())))) {
...
void example::thread_A_0_data_out() {
...
void example::thread_B_1_ack_in() {
    B_1_ack_in = B_1_state.read()[1];
}

void example::thread_B_1_ack_out() {
    B_1_ack_out = B_TREADY.read();
}

void example::thread_B_1_data_out() {
...
void example::thread_B_1_vld_out() {
...
void example::thread_ap_done() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && 
         esl_seteq<1,1,1>(B_1_ack_in.read(), ap_const_logic_1) && 
         esl_seteq<1,1,1>(ap_const_lv1_1, exitcond_fu_62_p2.read()))) {
...
void example::thread_ap_NS_fsm() {
    switch (ap_CS_fsm.read().to_uint64()) {
        case 1 : 
            ...
            break;
        case 2 : 
            if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && esl_seteq<1,1,1>(B_1_ack_in.read(), ap_const_logic_1) && esl_seteq<1,1,1>(ap_const_lv1_1, exitcond_fu_62_p2.read()))) {
                ap_NS_fsm = ap_ST_fsm_state1;
            } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && esl_seteq<1,1,1>(B_1_ack_in.read(), ap_const_logic_1) && esl_seteq<1,1,1>(ap_const_lv1_0, exitcond_fu_62_p2.read()))) {
            ...
            break;
        case 4 : 
            if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read()) && !(esl_seteq<1,1,1>(ap_const_logic_0, B_1_ack_in.read()) || esl_seteq<1,1,1>(ap_const_logic_0, A_0_vld_out.read())))) {
            ...
            break;
        case 8 : 
            if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read()) && esl_seteq<1,1,1>(B_1_ack_in.read(), ap_const_logic_1))) {
                ap_NS_fsm = ap_ST_fsm_state2;
            } else {
                ap_NS_fsm = ap_ST_fsm_state4;
            }
