...
architecture behav of example is 
    ...
    "example,hls_ip_2017_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg484-2,HLS_INPUT_CLOCK=13.333300,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=3.174000,HLS_SYN_LAT=151,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=276,HLS_SYN_LUT=157}";
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                if (((ap_const_logic_1 = A_0_vld_in) and (ap_const_logic_1 = A_0_ack_in))) then 
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                if ((((ap_const_logic_0 = A_0_vld_in) and (ap_const_logic_1 = A_0_ack_out) and (A_0_state = ap_const_lv2_3)) or ((ap_const_logic_0 = A_0_vld_in) and (A_0_state = ap_const_lv2_2)))) then 
                    A_0_state <= ap_const_lv2_2;
                elsif ((((ap_const_logic_1 = A_0_vld_in) and (ap_const_logic_0 = A_0_ack_out) and (A_0_state = ap_const_lv2_3)) or ((ap_const_logic_0 = A_0_ack_out) and (A_0_state = ap_const_lv2_1)))) then 
                    A_0_state <= ap_const_lv2_1;
                elsif ((((ap_const_logic_1 = A_0_vld_in) and (A_0_state = ap_const_lv2_2)) or ((ap_const_logic_1 = A_0_ack_out) and (A_0_state = ap_const_lv2_1)) or ((A_0_state = ap_const_lv2_3) and not(((ap_const_logic_1 = A_0_vld_in) and (ap_const_logic_0 = A_0_ack_out))) and not(((ap_const_logic_0 = A_0_vld_in) and (ap_const_logic_1 = A_0_ack_out)))))) then 
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                if ((((ap_const_logic_0 = B_1_vld_in) and (ap_const_logic_1 = B_1_ack_out) and (ap_const_lv2_3 = B_1_state)) or ((ap_const_logic_0 = B_1_vld_in) and (ap_const_lv2_2 = B_1_state)))) then 
                    B_1_state <= ap_const_lv2_2;
                elsif ((((ap_const_logic_1 = B_1_vld_in) and (ap_const_logic_0 = B_1_ack_out) and (ap_const_lv2_3 = B_1_state)) or ((ap_const_logic_0 = B_1_ack_out) and (ap_const_lv2_1 = B_1_state)))) then 
                    B_1_state <= ap_const_lv2_1;
                elsif ((((ap_const_logic_1 = B_1_vld_in) and (ap_const_lv2_2 = B_1_state)) or ((ap_const_logic_1 = B_1_ack_out) and (ap_const_lv2_1 = B_1_state)) or ((ap_const_lv2_3 = B_1_state) and not(((ap_const_logic_1 = B_1_vld_in) and (ap_const_logic_0 = B_1_ack_out))) and not(((ap_const_logic_0 = B_1_vld_in) and (ap_const_logic_1 = B_1_ack_out)))))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state4) and (B_1_ack_in = ap_const_logic_1))) then 
                i_reg_51 <= i_1_reg_84;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state2) and (B_1_ack_in = ap_const_logic_1))) then
    ...
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state2 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state2) and (B_1_ack_in = ap_const_logic_1) and (ap_const_lv1_1 = exitcond_fu_62_p2))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                elsif (((ap_const_logic_1 = ap_CS_fsm_state2) and (B_1_ack_in = ap_const_logic_1) and (ap_const_lv1_0 = exitcond_fu_62_p2))) then
                    ap_NS_fsm <= ap_ST_fsm_state3;
                else
                    ap_NS_fsm <= ap_ST_fsm_state2;
                end if;
            when ap_ST_fsm_state3 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state3) and not(((ap_const_logic_0 = B_1_ack_in) or (ap_const_logic_0 = A_0_vld_out))))) then
    ...
    A_0_load_A <= (A_0_state_cmp_full and not(A_0_sel_wr));
    A_0_load_B <= (A_0_sel_wr and A_0_state_cmp_full);
    A_0_sel <= A_0_sel_rd;
    ...
    B_1_load_A <= (B_1_state_cmp_full and not(B_1_sel_wr));
    B_1_load_B <= (B_1_sel_wr and B_1_state_cmp_full);
    B_1_sel <= B_1_sel_rd;
