...
begin
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_const_logic_1 = ap_continue)) then 
                    ap_done_reg <= ap_const_logic_0;
                elsif (((ap_const_logic_1 = ap_CS_fsm_state1) and not(((ap_const_logic_0 = real_start) or (ap_const_logic_0 = strm_len_out_full_n) or (ap_const_logic_0 = strm_len_out1_full_n) or (ap_done_reg = ap_const_logic_1))))) then 
    ...
    ap_NS_fsm_assign_proc : process (real_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, strm_len_out_full_n, strm_len_out1_full_n)
    begin
        case ap_CS_fsm is
    ...
    ap_block_state1_assign_proc : process(real_start, ap_done_reg, strm_len_out_full_n, strm_len_out1_full_n)
    begin
                ap_block_state1 <= ((ap_const_logic_0 = real_start) or (ap_const_logic_0 = strm_len_out_full_n) or (ap_const_logic_0 = strm_len_out1_full_n) or (ap_done_reg = ap_const_logic_1));
    end process;


    ap_done_assign_proc : process(real_start, ap_done_reg, ap_CS_fsm_state1, strm_len_out_full_n, strm_len_out1_full_n)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state1) and not(((ap_const_logic_0 = real_start) or (ap_const_logic_0 = strm_len_out_full_n) or (ap_const_logic_0 = strm_len_out1_full_n) or (ap_done_reg = ap_const_logic_1))))) then 
    ...
    internal_ap_ready_assign_proc : process(real_start, ap_done_reg, ap_CS_fsm_state1, strm_len_out_full_n, strm_len_out1_full_n)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state1) and not(((ap_const_logic_0 = real_start) or (ap_const_logic_0 = strm_len_out_full_n) or (ap_const_logic_0 = strm_len_out1_full_n) or (ap_done_reg = ap_const_logic_1))))) then 
    ...
    strm_len_out1_write_assign_proc : process(real_start, ap_done_reg, ap_CS_fsm_state1, strm_len_out_full_n, strm_len_out1_full_n)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state1) and not(((ap_const_logic_0 = real_start) or (ap_const_logic_0 = strm_len_out_full_n) or (ap_const_logic_0 = strm_len_out1_full_n) or (ap_done_reg = ap_const_logic_1))))) then 
    ...
    strm_len_out_write_assign_proc : process(real_start, ap_done_reg, ap_CS_fsm_state1, strm_len_out_full_n, strm_len_out1_full_n)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state1) and not(((ap_const_logic_0 = real_start) or (ap_const_logic_0 = strm_len_out_full_n) or (ap_const_logic_0 = strm_len_out1_full_n) or (ap_done_reg = ap_const_logic_1))))) then 
