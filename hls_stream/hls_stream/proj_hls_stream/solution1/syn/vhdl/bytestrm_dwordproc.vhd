...
architecture behav of bytestrm_dwordproc is 
    ...
    "bytestrm_dwordproc,hls_ip_2016_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7k160tfbg484-1,HLS_INPUT_CLOCK=5.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=3.760000,HLS_SYN_LAT=1490,HLS_SYN_TPT=1490,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=314,HLS_SYN_LUT=536}";
    ...
    signal strm_len_channel_full_n : STD_LOGIC;
    signal strm_len_channel_dout : STD_LOGIC_VECTOR (15 downto 0);
    signal strm_len_channel_empty_n : STD_LOGIC;
    signal strm_len_channel2_full_n : STD_LOGIC;
    signal strm_len_channel2_dout : STD_LOGIC_VECTOR (15 downto 0);
    signal strm_len_channel2_empty_n : STD_LOGIC;
    signal bytes_out_len_loc_ch_full_n : STD_LOGIC;
    signal bytes_out_len_loc_ch_dout : STD_LOGIC_VECTOR (13 downto 0);
    signal bytes_out_len_loc_ch_empty_n : STD_LOGIC;
    ...
    signal ap_sync_strm_bytes2words_U0_ap_start : STD_LOGIC;
    signal ap_sync_bytestrm_dwordproc_e_U0_ap_start : STD_LOGIC;
    ...
    component bytestrm_dwordprobkb IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
    ...
    component bytestrm_dwordprocud IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component bytestrm_dwordprodEe IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component bytestrm_dwordproeOg IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component bytestrm_dwordprofYi IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component bytestrm_dwordprog8j IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component start_for_strm_woibs IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    ...
    port map (
        ...
        strm_len_dout => strm_len_channel2_dout,
        strm_len_empty_n => strm_len_channel2_empty_n,
        strm_len_read => Block_proc_U0_strm_len_read,
        bytes_out_len_out_out_din => Block_proc_U0_bytes_out_len_out_out_din,
        bytes_out_len_out_out_full_n => bytes_out_len_loc_ch_full_n,
    ...
    port map (
        ...
        bytestrm_len_dout => strm_len_channel_dout,
        bytestrm_len_empty_n => strm_len_channel_empty_n,
    ...
    port map (
        ...
        bytes_out_len_loc_dout => bytes_out_len_loc_ch_dout,
        bytes_out_len_loc_empty_n => bytes_out_len_loc_ch_empty_n,
        bytes_out_len_loc_read => strm_words2bytes_U0_bytes_out_len_loc_read);

    strm_len_channel_U : component bytestrm_dwordprobkb
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        ...
        if_full_n => strm_len_channel_full_n,
        if_write => bytestrm_dwordproc_e_U0_strm_len_out_write,
        if_dout => strm_len_channel_dout,
        if_empty_n => strm_len_channel_empty_n,
        if_read => strm_bytes2words_U0_bytestrm_len_read);

    strm_len_channel2_U : component bytestrm_dwordprocud
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        ...
        if_full_n => strm_len_channel2_full_n,
        if_write => bytestrm_dwordproc_e_U0_strm_len_out1_write,
        if_dout => strm_len_channel2_dout,
        if_empty_n => strm_len_channel2_empty_n,
        if_read => Block_proc_U0_strm_len_read);

    bytes_out_len_loc_ch_U : component bytestrm_dwordprodEe
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        ...
        if_full_n => bytes_out_len_loc_ch_full_n,
        if_write => Block_proc_U0_bytes_out_len_out_out_write,
        if_dout => bytes_out_len_loc_ch_dout,
        if_empty_n => bytes_out_len_loc_ch_empty_n,
        if_read => strm_words2bytes_U0_bytes_out_len_loc_read);

    dwords_in_len_cast_l_U : component bytestrm_dwordproeOg
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    dwordstrm_in_V_U : component bytestrm_dwordprofYi
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    dwordstrm_out_V_U : component bytestrm_dwordprog8j
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_strm_woibs_U : component start_for_strm_woibs
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_hs_ready) and (bytestrm_dwordproc_e_U0_ap_ready = ap_const_logic_0))) then 
            ...
            elsif (((ap_hs_ready = ap_const_logic_0) and (bytestrm_dwordproc_e_U0_ap_ready = ap_const_logic_1))) then 
                bytestrm_dwordproc_e_U0_ap_ready_count <= std_logic_vector(unsigned(bytestrm_dwordproc_e_U0_ap_ready_count) + unsigned(ap_const_lv2_1));
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((strm_bytes2words_U0_ap_ready = ap_const_logic_0) and (ap_const_logic_1 = ap_hs_ready))) then 
                strm_bytes2words_U0_ap_ready_count <= std_logic_vector(unsigned(strm_bytes2words_U0_ap_ready_count) - unsigned(ap_const_lv2_1));
            elsif (((ap_const_logic_1 = strm_bytes2words_U0_ap_ready) and (ap_hs_ready = ap_const_logic_0))) then 
                strm_bytes2words_U0_ap_ready_count <= std_logic_vector(unsigned(strm_bytes2words_U0_ap_ready_count) + unsigned(ap_const_lv2_1));
            end if; 
        end if;
    end process;
    ...
    ap_hs_done <= strm_words2bytes_U0_ap_done;
    ap_hs_ready <= (ap_sync_strm_bytes2words_U0_ap_ready and ap_sync_bytestrm_dwordproc_e_U0_ap_ready);
    ap_idle <= (bytestrm_dwordproc_e_U0_ap_idle and Block_proc_U0_ap_idle and strm_bytes2words_U0_ap_idle and decimate_strm_U0_ap_idle and strm_words2bytes_U0_ap_idle and (dwords_in_len_cast_l_empty_n xor ap_const_logic_1));
    ...
    ap_sync_bytestrm_dwordproc_e_U0_ap_start <= (ap_start and (ap_sync_reg_bytestrm_dwordproc_e_U0_ap_ready xor ap_const_logic_1));
    ap_sync_strm_bytes2words_U0_ap_ready <= (strm_bytes2words_U0_ap_ready or ap_sync_reg_strm_bytes2words_U0_ap_ready);
    ap_sync_strm_bytes2words_U0_ap_start <= (ap_start and (ap_sync_reg_strm_bytes2words_U0_ap_ready xor ap_const_logic_1));
    bytestrm_dwordproc_e_U0_ap_continue <= ap_const_logic_1;
    bytestrm_dwordproc_e_U0_ap_start <= ap_sync_bytestrm_dwordproc_e_U0_ap_start;
    ...
    strm_bytes2words_U0_ap_start <= ap_sync_strm_bytes2words_U0_ap_start;
