...
architecture behav of bytestrm_dwordproc is 
    ...
    "bytestrm_dwordproc,hls_ip_2017_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7k160tfbg484-1,HLS_INPUT_CLOCK=5.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=4.332500,HLS_SYN_LAT=1490,HLS_SYN_TPT=1490,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=676,HLS_SYN_LUT=693}";
    ...
    signal bytestrm_dwordproc_e_U0_start_full_n : STD_LOGIC;
...
begin
    ...
    port map (
        ...
        start_full_n => bytestrm_dwordproc_e_U0_start_full_n,
    ...
    port map (
        ...
        start_full_n => Block_proc_U0_start_full_n,
    ...
    strm_len_channel_U : component fifo_w16_d1_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
    ...
    strm_len_channel2_U : component fifo_w16_d1_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    bytes_out_len_loc_ch_U : component fifo_w14_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    dwordstrm_out_V_U : component fifo_w32_d1_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_sync_ready) and (bytestrm_dwordproc_e_U0_ap_ready = ap_const_logic_0))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((strm_bytes2words_U0_ap_ready = ap_const_logic_0) and (ap_const_logic_1 = ap_sync_ready))) then 
                strm_bytes2words_U0_ap_ready_count <= std_logic_vector(unsigned(strm_bytes2words_U0_ap_ready_count) - unsigned(ap_const_lv2_1));
            elsif (((ap_const_logic_1 = strm_bytes2words_U0_ap_ready) and (ap_sync_ready = ap_const_logic_0))) then 
                strm_bytes2words_U0_ap_ready_count <= std_logic_vector(unsigned(strm_bytes2words_U0_ap_ready_count) + unsigned(ap_const_lv2_1));
            end if; 
        end if;
    end process;
    ...
    Block_proc_U0_start_full_n <= (ap_const_logic_0 or start_for_strm_words2bytes_U0_full_n);
    ...
    bytestrm_dwordproc_e_U0_ap_start <= (ap_start and (ap_sync_reg_bytestrm_dwordproc_e_U0_ap_ready xor ap_const_logic_1));
    bytestrm_dwordproc_e_U0_start_full_n <= (ap_const_logic_0 or start_for_Block_proc_U0_full_n);
    decimate_strm_U0_ap_continue <= ap_const_logic_1;
    decimate_strm_U0_ap_start <= dwords_in_len_cast_l_empty_n;
    decimate_strm_U0_start_full_n <= ap_const_logic_0;
    ...
    strm_bytes2words_U0_ap_start <= (ap_start and (ap_sync_reg_strm_bytes2words_U0_ap_ready xor ap_const_logic_1));
    strm_bytes2words_U0_start_full_n <= ap_const_logic_0;
    ...
    strm_words2bytes_U0_start_full_n <= ap_const_logic_0;
