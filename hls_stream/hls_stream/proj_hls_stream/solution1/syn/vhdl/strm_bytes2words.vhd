...
begin
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_const_logic_1 = ap_continue)) then 
                    ap_done_reg <= ap_const_logic_0;
                elsif (((ap_const_lv1_1 = ap_CS_fsm_state2) and not((ap_const_lv1_0 = exitcond_i_fu_132_p2)))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_lv1_1 = ap_CS_fsm_state3) and not((ap_condition_145 = ap_const_boolean_1)))) then 
                i_i_reg_117 <= i_reg_184;
            elsif (((ap_CS_fsm_state1 = ap_const_lv1_1) and not((ap_condition_123 = ap_const_boolean_1)))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_CS_fsm_state1 = ap_const_lv1_1) and not((ap_condition_123 = ap_const_boolean_1)))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_lv1_1 = ap_CS_fsm_state2) and (ap_const_lv1_0 = exitcond_i_fu_132_p2))) then
                tmp_1_i_reg_189 <= tmp_1_i_fu_143_p2;
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_CS_fsm, ap_condition_123, exitcond_i_fu_132_p2, ap_condition_145)
    begin
        case ap_CS_fsm is
            when ap_ST_fsm_state1 => 
                if (not((ap_condition_123 = ap_const_boolean_1))) then
                    ap_NS_fsm <= ap_ST_fsm_state2;
                else
                    ap_NS_fsm <= ap_ST_fsm_state1;
                end if;
            when ap_ST_fsm_state2 => 
                if (not((ap_const_lv1_0 = exitcond_i_fu_132_p2))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
                    ap_NS_fsm <= ap_ST_fsm_state3;
                end if;
            when ap_ST_fsm_state3 => 
                if (not((ap_condition_145 = ap_const_boolean_1))) then
                    ap_NS_fsm <= ap_ST_fsm_state2;
                else
                    ap_NS_fsm <= ap_ST_fsm_state3;
                end if;
    ...
    ap_condition_123_assign_proc : process(ap_start, ap_done_reg, bytestrm_len_empty_n)
    begin
                ap_condition_123 <= ((ap_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1) or (bytestrm_len_empty_n = ap_const_logic_0));
    end process;


    ap_condition_145_assign_proc : process(words_out_V_full_n, bytes_in_V_0_vld_out, tmp_1_i_reg_189)
    begin
                ap_condition_145 <= ((bytes_in_V_0_vld_out = ap_const_logic_0) or (not((ap_const_lv1_0 = tmp_1_i_reg_189)) and (words_out_V_full_n = ap_const_logic_0)));
    end process;


    ap_done_assign_proc : process(ap_done_reg, ap_CS_fsm_state2, exitcond_i_fu_132_p2)
    begin
        if (((ap_const_logic_1 = ap_done_reg) or ((ap_const_lv1_1 = ap_CS_fsm_state2) and not((ap_const_lv1_0 = exitcond_i_fu_132_p2))))) then 
    ...
    begin
        if (((ap_const_lv1_1 = ap_CS_fsm_state2) and not((ap_const_lv1_0 = exitcond_i_fu_132_p2)))) then 
    ...
    bytes_in_V_0_ack_out_assign_proc : process(ap_CS_fsm_state3, ap_condition_145)
    begin
        if (((ap_const_lv1_1 = ap_CS_fsm_state3) and not((ap_condition_145 = ap_const_boolean_1)))) then 
    ...
    bytestrm_len_read_assign_proc : process(ap_CS_fsm_state1, ap_condition_123)
    begin
        if (((ap_CS_fsm_state1 = ap_const_lv1_1) and not((ap_condition_123 = ap_const_boolean_1)))) then 
    ...
    begin
        if (((ap_const_lv1_1 = ap_CS_fsm_state3) and not((ap_const_lv1_0 = tmp_1_i_reg_189)))) then 
    ...
    words_out_V_write_assign_proc : process(ap_CS_fsm_state3, tmp_1_i_reg_189, ap_condition_145)
    begin
        if (((ap_const_lv1_1 = ap_CS_fsm_state3) and not((ap_const_lv1_0 = tmp_1_i_reg_189)) and not((ap_condition_145 = ap_const_boolean_1)))) then 
