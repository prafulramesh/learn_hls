...
begin
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_const_logic_1 = ap_continue)) then 
                    ap_done_reg <= ap_const_logic_0;
                elsif (((ap_const_logic_1 = ap_CS_fsm_state1) and not(((ap_const_logic_0 = real_start) or (ap_const_logic_0 = strm_len_empty_n) or (ap_const_logic_0 = bytes_out_len_out_out_full_n) or (ap_done_reg = ap_const_logic_1))))) then 
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((ap_const_logic_1 = ap_CS_fsm_state1) and not(((ap_const_logic_0 = real_start) or (ap_const_logic_0 = strm_len_empty_n) or (ap_const_logic_0 = bytes_out_len_out_out_full_n) or (ap_done_reg = ap_const_logic_1))))) then 
    ...
    begin
                ap_block_state1 <= ((ap_const_logic_0 = real_start) or (ap_const_logic_0 = strm_len_empty_n) or (ap_const_logic_0 = bytes_out_len_out_out_full_n) or (ap_done_reg = ap_const_logic_1));
    end process;
