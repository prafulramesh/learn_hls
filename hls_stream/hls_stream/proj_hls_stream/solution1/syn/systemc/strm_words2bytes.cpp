...
strm_words2bytes::strm_words2bytes(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    SC_METHOD(thread_p_0_1_i_i_phi_fu_117_p4);
    ...
    sensitive << ( p_0_1_i_i_phi_fu_117_p4 );
    ...
    sc_trace(mVcdFile, p_0_1_i_i_phi_fu_117_p4, "p_0_1_i_i_phi_fu_117_p4");
    ...
    if ( ap_rst.read() == ap_const_logic_1) {
        ...
        if (esl_seteq<1,1,1>(ap_const_logic_1, ap_continue.read())) {
            ap_done_reg = ap_const_logic_0;
                    ...
                    !(esl_seteq<1,1,1>(ap_condition_144.read(), ap_const_boolean_1) || (esl_seteq<1,1,1>(ap_const_lv1_0, exitcond_i_i_fu_144_p2.read()) && 
  esl_seteq<1,1,1>(ap_const_logic_0, bytes_out_V_1_ack_in.read()))))) {
    ...
    if ((esl_seteq<1,1,1>(ap_const_lv1_1, ap_CS_fsm_state3.read()) && 
        ...
        i_i_i_reg_103 = i_reg_195.read();
                ...
                !esl_seteq<1,1,1>(ap_condition_134.read(), ap_const_boolean_1))) {
    ...
    if ((esl_seteq<1,1,1>(ap_const_lv1_1, ap_CS_fsm_state2.read()) && !(esl_seteq<1,1,1>(ap_condition_144.read(), ap_const_boolean_1) || (esl_seteq<1,1,1>(ap_const_lv1_0, exitcond_i_i_fu_144_p2.read()) && 
  esl_seteq<1,1,1>(ap_const_logic_0, bytes_out_V_1_ack_in.read()))))) {
        i_reg_195 = i_fu_149_p2.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_lv1_1, ap_CS_fsm_state2.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, exitcond_i_i_fu_144_p2.read()) && !(esl_seteq<1,1,1>(ap_condition_144.read(), ap_const_boolean_1) || (esl_seteq<1,1,1>(ap_const_lv1_0, exitcond_i_i_fu_144_p2.read()) && 
  esl_seteq<1,1,1>(ap_const_logic_0, bytes_out_V_1_ack_in.read()))))) {
        p_0_i_i_fu_80 = p_0_1_i_i_phi_fu_117_p4.read().range(31, 8);
    }
    if ((esl_seteq<1,1,1>(ap_CS_fsm_state1.read(), ap_const_lv1_1) && !esl_seteq<1,1,1>(ap_condition_134.read(), ap_const_boolean_1))) {
...
void strm_words2bytes::thread_ap_condition_134() {
    ap_condition_134 = (esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_0) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1) || esl_seteq<1,1,1>(bytes_out_len_loc_empty_n.read(), ap_const_logic_0));
}

void strm_words2bytes::thread_ap_condition_144() {
    ap_condition_144 = ((esl_seteq<1,1,1>(ap_const_lv1_0, exitcond_i_i_fu_144_p2.read()) && 
  !esl_seteq<1,1,1>(ap_const_lv1_0, tmp_2_i_i_fu_155_p2.read()) && 
  esl_seteq<1,1,1>(words_in_V_empty_n.read(), ap_const_logic_0)) || esl_seteq<1,1,1>(bytes_out_V_1_ack_in.read(), ap_const_logic_0));
}
...
void strm_words2bytes::thread_bytes_out_V_1_ack_in() {
    bytes_out_V_1_ack_in =  (sc_logic) (bytes_out_V_1_state.read()[1]);
}
...
void strm_words2bytes::thread_bytes_out_V_1_vld_out() {
    bytes_out_V_1_vld_out =  (sc_logic) (bytes_out_V_1_state.read()[0]);
}
...
void strm_words2bytes::thread_bytes_out_V_TDATA_blk_n() {
    if (((esl_seteq<1,1,1>(ap_const_lv1_1, ap_CS_fsm_state2.read()) && 
        ...
        bytes_out_V_TDATA_blk_n =  (sc_logic) (bytes_out_V_1_state.read()[1]);
    } else {
...
void strm_words2bytes::thread_bytes_out_V_TVALID() {
    bytes_out_V_TVALID =  (sc_logic) (bytes_out_V_1_state.read()[0]);
}
...
void strm_words2bytes::thread_p_0_1_i_i_phi_fu_117_p4() {
    if ((esl_seteq<1,1,1>(ap_const_lv1_1, ap_CS_fsm_state2.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, exitcond_i_i_fu_144_p2.read()))) {
        if (esl_seteq<1,1,1>(ap_const_lv1_0, tmp_2_i_i_fu_155_p2.read())) {
            p_0_1_i_i_phi_fu_117_p4 = p_0_cast_i_i_fu_131_p1.read();
        } else if (!esl_seteq<1,1,1>(ap_const_lv1_0, tmp_2_i_i_fu_155_p2.read())) {
            p_0_1_i_i_phi_fu_117_p4 = words_in_V_dout.read();
        } else {
...
void strm_words2bytes::thread_tmpbyte_fu_161_p1() {
    tmpbyte_fu_161_p1 = p_0_1_i_i_phi_fu_117_p4.read().range(8-1, 0);
}
...
void strm_words2bytes::thread_ap_NS_fsm() {
    switch (ap_CS_fsm.read().to_uint64()) {
        case 1 : 
            ...
            break;
        case 2 : 
            if ((!esl_seteq<1,1,1>(ap_const_lv1_0, exitcond_i_i_fu_144_p2.read()) && !(esl_seteq<1,1,1>(ap_condition_144.read(), ap_const_boolean_1) || (esl_seteq<1,1,1>(ap_const_lv1_0, exitcond_i_i_fu_144_p2.read()) && 
  esl_seteq<1,1,1>(ap_const_logic_0, bytes_out_V_1_ack_in.read()))))) {
                ap_NS_fsm = ap_ST_fsm_state1;
            } else if ((esl_seteq<1,1,1>(ap_const_lv1_0, exitcond_i_i_fu_144_p2.read()) && !(esl_seteq<1,1,1>(ap_condition_144.read(), ap_const_boolean_1) || (esl_seteq<1,1,1>(ap_const_lv1_0, exitcond_i_i_fu_144_p2.read()) && 
  esl_seteq<1,1,1>(ap_const_logic_0, bytes_out_V_1_ack_in.read()))))) {
            ...
            break;
        case 4 : 
            if (!esl_seteq<1,1,1>(ap_const_logic_0, bytes_out_V_1_ack_in.read())) {
                ap_NS_fsm = ap_ST_fsm_state2;
            } else {
                ap_NS_fsm = ap_ST_fsm_state3;
            }
