...
#ifndef bytestrm_dwordprofYi_HH_
#define bytestrm_dwordprofYi_HH_

#include <systemc>
using namespace std;
SC_MODULE(bytestrm_dwordprofYi) {
    static const unsigned int DATA_WIDTH = 32;
    static const unsigned int ADDR_WIDTH = 3;
    static const unsigned int bytestrm_dwordprofYi_depth = 5;
    ...
    sc_core::sc_signal< sc_dt::sc_lv<DATA_WIDTH> >  mStorage[bytestrm_dwordprofYi_depth];
    ...
    SC_CTOR(bytestrm_dwordprofYi) : mTrace(0) {
        ...
        SC_METHOD(proc_dout);
        sensitive << mOutPtr;
        for (unsigned i = 0; i < bytestrm_dwordprofYi_depth; i++) {
        ...
        if (reset.read() == sc_dt::SC_LOGIC_1) {
            ...
            if (if_read_ce.read() == sc_dt::SC_LOGIC_1
               ...
               && internal_empty_n.read() == sc_dt::SC_LOGIC_1) {
                ...
                if (mOutPtr.read().to_uint() == (bytestrm_dwordprofYi_depth-1)) {
                    ptr = 0;
                ...
                assert(ptr.to_uint() < bytestrm_dwordprofYi_depth);
                mOutPtr.write(ptr);
            }
            if (if_write_ce.read() == sc_dt::SC_LOGIC_1
                ...
                if (ptr.to_uint() == (bytestrm_dwordprofYi_depth-1)) {
                    ptr = 0;
                    mFlag_nEF_hint.write(~mFlag_nEF_hint.read());
                } else {
                    ptr++;
    ...
    void proc_dout() {
        ...
        if (ptr.to_uint() > bytestrm_dwordprofYi_depth) {
...
#endif //bytestrm_dwordprofYi_HH_
