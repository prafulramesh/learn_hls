...
void Block_proc::thread_ap_condition_56() {
    ap_condition_56 = (esl_seteq<1,1,1>(strm_len_empty_n.read(), ap_const_logic_0) || esl_seteq<1,1,1>(bytes_out_len_out_out_full_n.read(), ap_const_logic_0) || esl_seteq<1,1,1>(real_start.read(), ap_const_logic_0) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1));
}
