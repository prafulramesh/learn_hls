...
bytestrm_dwordproc::bytestrm_dwordproc(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    bytestrm_dwordproc_e_U0->start_full_n(bytestrm_dwordproc_e_U0_start_full_n);
    ...
    Block_proc_U0->start_full_n(Block_proc_U0_start_full_n);
    ...
    strm_len_channel_U = new fifo_w16_d1_A("strm_len_channel_U");
    ...
    strm_len_channel2_U = new fifo_w16_d1_A("strm_len_channel2_U");
    ...
    bytes_out_len_loc_ch_U = new fifo_w14_d2_A("bytes_out_len_loc_ch_U");
    ...
    dwordstrm_out_V_U = new fifo_w32_d1_A("dwordstrm_out_V_U");
    ...
    start_for_Block_pbkb_U = new start_for_Block_pbkb("start_for_Block_pbkb_U");
    start_for_Block_pbkb_U->clk(ap_clk);
    start_for_Block_pbkb_U->reset(ap_rst_n_inv);
    start_for_Block_pbkb_U->if_read_ce(ap_var_for_const0);
    start_for_Block_pbkb_U->if_write_ce(ap_var_for_const0);
    start_for_Block_pbkb_U->if_din(start_for_Block_proc_U0_din);
    start_for_Block_pbkb_U->if_full_n(start_for_Block_proc_U0_full_n);
    start_for_Block_pbkb_U->if_write(bytestrm_dwordproc_e_U0_start_write);
    start_for_Block_pbkb_U->if_dout(start_for_Block_proc_U0_dout);
    start_for_Block_pbkb_U->if_empty_n(start_for_Block_proc_U0_empty_n);
    start_for_Block_pbkb_U->if_read(Block_proc_U0_ap_ready);
    start_for_strm_wocud_U = new start_for_strm_wocud("start_for_strm_wocud_U");
    start_for_strm_wocud_U->clk(ap_clk);
    start_for_strm_wocud_U->reset(ap_rst_n_inv);
    start_for_strm_wocud_U->if_read_ce(ap_var_for_const0);
    start_for_strm_wocud_U->if_write_ce(ap_var_for_const0);
    start_for_strm_wocud_U->if_din(start_for_strm_words2bytes_U0_din);
    start_for_strm_wocud_U->if_full_n(start_for_strm_words2bytes_U0_full_n);
    start_for_strm_wocud_U->if_write(Block_proc_U0_start_write);
    start_for_strm_wocud_U->if_dout(start_for_strm_words2bytes_U0_dout);
    start_for_strm_wocud_U->if_empty_n(start_for_strm_words2bytes_U0_empty_n);
    start_for_strm_wocud_U->if_read(strm_words2bytes_U0_ap_ready);
    ...
    sensitive << ( start_for_strm_words2bytes_U0_full_n );
    ...
    SC_METHOD(thread_bytestrm_dwordproc_e_U0_start_full_n);
    ...
    sc_trace(mVcdFile, bytestrm_dwordproc_e_U0_start_full_n, "bytestrm_dwordproc_e_U0_start_full_n");
...
bytestrm_dwordproc::~bytestrm_dwordproc() {
    ...
    delete start_for_Block_pbkb_U;
    delete start_for_strm_wocud_U;
}
...
void bytestrm_dwordproc::thread_Block_proc_U0_start_full_n() {
    Block_proc_U0_start_full_n = (ap_const_logic_0 | start_for_strm_words2bytes_U0_full_n.read());
}
...
void bytestrm_dwordproc::thread_ap_sync_ready() {
    ap_sync_ready = (ap_sync_strm_bytes2words_U0_ap_ready.read() & ap_sync_bytestrm_dwordproc_e_U0_ap_ready.read());
}
...
void bytestrm_dwordproc::thread_bytestrm_dwordproc_e_U0_start_full_n() {
    bytestrm_dwordproc_e_U0_start_full_n = (ap_const_logic_0 | start_for_Block_proc_U0_full_n.read());
}
