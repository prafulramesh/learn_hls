...
#include "bytestrm_dwordprobkb.h"
#include "bytestrm_dwordprocud.h"
#include "bytestrm_dwordprodEe.h"
#include "bytestrm_dwordproeOg.h"
#include "bytestrm_dwordprofYi.h"
#include "bytestrm_dwordprog8j.h"
#include "start_for_Block_phbi.h"
#include "start_for_strm_woibs.h"
...
struct bytestrm_dwordproc : public sc_module {
    ...
    sc_signal< sc_logic > strm_len_channel_full_n;
    sc_signal< sc_lv<16> > strm_len_channel_dout;
    sc_signal< sc_logic > strm_len_channel_empty_n;
    sc_signal< sc_logic > strm_len_channel2_full_n;
    sc_signal< sc_lv<16> > strm_len_channel2_dout;
    sc_signal< sc_logic > strm_len_channel2_empty_n;
    sc_signal< sc_logic > bytes_out_len_loc_ch_full_n;
    sc_signal< sc_lv<14> > bytes_out_len_loc_ch_dout;
    sc_signal< sc_logic > bytes_out_len_loc_ch_empty_n;
    ...
    sc_signal< sc_logic > ap_sync_strm_bytes2words_U0_ap_start;
    sc_signal< sc_logic > ap_sync_bytestrm_dwordproc_e_U0_ap_start;
    ...
    void thread_ap_sync_bytestrm_dwordproc_e_U0_ap_start();
    void thread_ap_sync_strm_bytes2words_U0_ap_ready();
    void thread_ap_sync_strm_bytes2words_U0_ap_start();
