...
const sc_lv<3> decimate_strm::ap_ST_fsm_state5 = "100";
...
decimate_strm::decimate_strm(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    sensitive << ( tmp_3_i3_reg_247 );
    sensitive << ( acc_i_phi_fu_143_p4 );

    SC_METHOD(thread_acc_i_phi_fu_143_p4);
    sensitive << ( ap_enable_reg_pp0_iter2 );
    sensitive << ( ap_block_pp0_stage0_flag00000000 );
    sensitive << ( acc_i_reg_139 );
    sensitive << ( ap_reg_pp0_iter1_exitcond_flatten_reg_238 );
    sensitive << ( acc_reg_261 );
    ...
    sensitive << ( ap_enable_reg_pp0_iter2 );
    sensitive << ( ap_reg_pp0_iter1_tmp_5_i_reg_252 );
    sensitive << ( ap_enable_reg_pp0_iter1 );
    sensitive << ( exitcond_flatten_reg_238 );
    ...
    sc_trace(mVcdFile, tmp_5_i_reg_252, "tmp_5_i_reg_252");
    sc_trace(mVcdFile, ap_reg_pp0_iter1_tmp_5_i_reg_252, "ap_reg_pp0_iter1_tmp_5_i_reg_252");
    sc_trace(mVcdFile, strm_in_V_blk_n, "strm_in_V_blk_n");
    sc_trace(mVcdFile, ap_CS_fsm_pp0_stage0, "ap_CS_fsm_pp0_stage0");
    sc_trace(mVcdFile, ap_enable_reg_pp0_iter1, "ap_enable_reg_pp0_iter1");
    sc_trace(mVcdFile, exitcond_flatten_reg_238, "exitcond_flatten_reg_238");
    ...
    sc_trace(mVcdFile, tmp_8_reg_233, "tmp_8_reg_233");
    ...
    sc_trace(mVcdFile, ap_reg_pp0_iter1_exitcond_flatten_reg_238, "ap_reg_pp0_iter1_exitcond_flatten_reg_238");
    ...
    sc_trace(mVcdFile, tmp_3_i3_reg_247, "tmp_3_i3_reg_247");
    ...
    sc_trace(mVcdFile, acc_reg_261, "acc_reg_261");
    sc_trace(mVcdFile, tmp_6_reg_266, "tmp_6_reg_266");
    sc_trace(mVcdFile, ap_block_pp0_stage0_flag00011011, "ap_block_pp0_stage0_flag00011011");
    sc_trace(mVcdFile, ap_condition_pp0_exit_iter0_state2, "ap_condition_pp0_exit_iter0_state2");
    sc_trace(mVcdFile, acc_i_phi_fu_143_p4, "acc_i_phi_fu_143_p4");
...
void decimate_strm::thread_ap_clk_no_reset_() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter2.read()) && 
         ...
         esl_seteq<1,1,1>(ap_const_lv1_0, ap_reg_pp0_iter1_exitcond_flatten_reg_238.read()))) {
        acc_i_reg_139 = acc_reg_261.read();
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter1.read()) && esl_seteq<1,1,1>(exitcond_flatten_reg_238.read(), ap_const_lv1_0) && esl_seteq<1,1,1>(ap_block_pp0_stage0_flag00011001.read(), ap_const_boolean_0))) {
        acc_reg_261 = acc_fu_217_p2.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage0_flag00011001.read(), ap_const_boolean_0))) {
        ap_reg_pp0_iter1_exitcond_flatten_reg_238 = exitcond_flatten_reg_238.read();
        ap_reg_pp0_iter1_tmp_5_i_reg_252 = tmp_5_i_reg_252.read();
        exitcond_flatten_reg_238 = exitcond_flatten_fu_169_p2.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage0_flag00011001.read(), ap_const_boolean_0) && esl_seteq<1,1,1>(ap_const_lv1_0, exitcond_flatten_fu_169_p2.read()))) {
        tmp_3_i3_reg_247 = tmp_3_i3_fu_180_p2.read();
        tmp_5_i_reg_252 = tmp_5_i_fu_194_p2.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage0_flag00011001.read(), ap_const_boolean_0) && esl_seteq<1,1,1>(tmp_5_i_reg_252.read(), ap_const_lv1_1))) {
        tmp_6_reg_266 = acc_fu_217_p2.read().range(33, 2);
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && !(esl_seteq<1,1,1>(ap_const_logic_0, ap_start.read()) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1)))) {
        tmp_8_reg_233 = tmp_8_fu_161_p3.read();
    }
}
...
void decimate_strm::thread_acc_i_mid2_fu_206_p3() {
    acc_i_mid2_fu_206_p3 = (!tmp_3_i3_reg_247.read()[0].is_01())? sc_lv<34>(): ((tmp_3_i3_reg_247.read()[0].to_bool())? ap_const_lv34_0: acc_i_phi_fu_143_p4.read());
}

void decimate_strm::thread_acc_i_phi_fu_143_p4() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter2.read()) && 
         esl_seteq<1,1,1>(ap_block_pp0_stage0_flag00000000.read(), ap_const_boolean_0) && 
         esl_seteq<1,1,1>(ap_const_lv1_0, ap_reg_pp0_iter1_exitcond_flatten_reg_238.read()))) {
        acc_i_phi_fu_143_p4 = acc_reg_261.read();
    } else {
        acc_i_phi_fu_143_p4 = acc_i_reg_139.read();
    }
}
...
void decimate_strm::thread_ap_CS_fsm_state5() {
    ap_CS_fsm_state5 = ap_CS_fsm.read()[2];
}

void decimate_strm::thread_ap_block_pp0_stage0_flag00000000() {
    ap_block_pp0_stage0_flag00000000 = !esl_seteq<1,1,1>(ap_const_boolean_1, ap_const_boolean_1);
}

void decimate_strm::thread_ap_block_pp0_stage0_flag00001001() {
    ap_block_pp0_stage0_flag00001001 = ((esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter1.read()) && 
  esl_seteq<1,1,1>(exitcond_flatten_reg_238.read(), ap_const_lv1_0) && 
  esl_seteq<1,1,1>(ap_const_logic_0, strm_in_V_empty_n.read())) || (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter2.read()) && 
  esl_seteq<1,1,1>(ap_reg_pp0_iter1_tmp_5_i_reg_252.read(), ap_const_lv1_1) && 
  esl_seteq<1,1,1>(ap_const_logic_0, strm_out_V_full_n.read())));
}

void decimate_strm::thread_ap_block_pp0_stage0_flag00011001() {
...
void decimate_strm::thread_ap_block_pp0_stage0_flag00011011() {
...
void decimate_strm::thread_ap_block_state3_pp0_stage0_iter1() {
    ap_block_state3_pp0_stage0_iter1 = (esl_seteq<1,1,1>(exitcond_flatten_reg_238.read(), ap_const_lv1_0) && esl_seteq<1,1,1>(ap_const_logic_0, strm_in_V_empty_n.read()));
}

void decimate_strm::thread_ap_block_state4_pp0_stage0_iter2() {
    ap_block_state4_pp0_stage0_iter2 = (esl_seteq<1,1,1>(ap_reg_pp0_iter1_tmp_5_i_reg_252.read(), ap_const_lv1_1) && esl_seteq<1,1,1>(ap_const_logic_0, strm_out_V_full_n.read()));
}

void decimate_strm::thread_ap_condition_pp0_exit_iter0_state2() {
    if (esl_seteq<1,1,1>(ap_const_lv1_1, exitcond_flatten_fu_169_p2.read())) {
...
void decimate_strm::thread_exitcond_flatten_fu_169_p2() {
    exitcond_flatten_fu_169_p2 = (!indvar_flatten_reg_117.read().is_01() || !tmp_8_reg_233.read().is_01())? sc_lv<1>(): sc_lv<1>(indvar_flatten_reg_117.read() == tmp_8_reg_233.read());
}
...
void decimate_strm::thread_strm_out_V_din() {
    strm_out_V_din = tmp_6_reg_266.read();
}
...
void decimate_strm::thread_ap_NS_fsm() {
    switch (ap_CS_fsm.read().to_uint64()) {
        case 1 : 
            ...
            break;
        case 2 : 
            if ((!(esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter2.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage0_flag00011011.read(), ap_const_boolean_0) && esl_seteq<1,1,1>(ap_enable_reg_pp0_iter1.read(), ap_const_logic_0)) && !(esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter0.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage0_flag00011011.read(), ap_const_boolean_0) && esl_seteq<1,1,1>(ap_const_lv1_1, exitcond_flatten_fu_169_p2.read()) && esl_seteq<1,1,1>(ap_enable_reg_pp0_iter1.read(), ap_const_logic_0)))) {
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            } else if (((esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter2.read()) && 
  esl_seteq<1,1,1>(ap_block_pp0_stage0_flag00011011.read(), ap_const_boolean_0) && 
  esl_seteq<1,1,1>(ap_enable_reg_pp0_iter1.read(), ap_const_logic_0)) || (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter0.read()) && 
  esl_seteq<1,1,1>(ap_block_pp0_stage0_flag00011011.read(), ap_const_boolean_0) && 
  esl_seteq<1,1,1>(ap_const_lv1_1, exitcond_flatten_fu_169_p2.read()) && 
