...
void strm_bytes2words::thread_ap_clk_no_reset_() {
    ...
    if ( ap_rst.read() == ap_const_logic_1) {
        ...
        if (esl_seteq<1,1,1>(ap_const_logic_1, ap_continue.read())) {
            ap_done_reg = ap_const_logic_0;
                    ...
                    !esl_seteq<1,1,1>(ap_const_lv1_0, exitcond_i_fu_132_p2.read()))) {
    ...
    if ((esl_seteq<1,1,1>(ap_const_lv1_1, ap_CS_fsm_state3.read()) && 
         !esl_seteq<1,1,1>(ap_condition_145.read(), ap_const_boolean_1))) {
        i_i_reg_117 = i_reg_184.read();
    } else if ((esl_seteq<1,1,1>(ap_CS_fsm_state1.read(), ap_const_lv1_1) && 
                !esl_seteq<1,1,1>(ap_condition_123.read(), ap_const_boolean_1))) {
    ...
    if ((esl_seteq<1,1,1>(ap_CS_fsm_state1.read(), ap_const_lv1_1) && !esl_seteq<1,1,1>(ap_condition_123.read(), ap_const_boolean_1))) {
        bytestrm_len_read_reg_176 = bytestrm_len_dout.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_lv1_1, ap_CS_fsm_state2.read()))) {
        i_reg_184 = i_fu_137_p2.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_lv1_1, ap_CS_fsm_state2.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, exitcond_i_fu_132_p2.read()))) {
...
void strm_bytes2words::thread_ap_condition_123() {
    ap_condition_123 = (esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_0) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1) || esl_seteq<1,1,1>(bytestrm_len_empty_n.read(), ap_const_logic_0));
}

void strm_bytes2words::thread_ap_condition_145() {
    ap_condition_145 = (esl_seteq<1,1,1>(bytes_in_V_0_vld_out.read(), ap_const_logic_0) || (!esl_seteq<1,1,1>(ap_const_lv1_0, tmp_1_i_reg_189.read()) && 
  esl_seteq<1,1,1>(words_out_V_full_n.read(), ap_const_logic_0)));
}
...
void strm_bytes2words::thread_bytes_in_V_0_ack_in() {
    bytes_in_V_0_ack_in =  (sc_logic) (bytes_in_V_0_state.read()[1]);
}
...
void strm_bytes2words::thread_bytes_in_V_0_vld_out() {
    bytes_in_V_0_vld_out =  (sc_logic) (bytes_in_V_0_state.read()[0]);
}

void strm_bytes2words::thread_bytes_in_V_TDATA_blk_n() {
    if ((esl_seteq<1,1,1>(ap_const_lv1_1, ap_CS_fsm_state3.read()))) {
        bytes_in_V_TDATA_blk_n =  (sc_logic) (bytes_in_V_0_state.read()[0]);
    } else {
...
void strm_bytes2words::thread_bytes_in_V_TREADY() {
    bytes_in_V_TREADY =  (sc_logic) (bytes_in_V_0_state.read()[1]);
}
...
void strm_bytes2words::thread_words_out_V_blk_n() {
    if ((esl_seteq<1,1,1>(ap_const_lv1_1, ap_CS_fsm_state3.read()) && 
         !esl_seteq<1,1,1>(ap_const_lv1_0, tmp_1_i_reg_189.read()))) {
...
void strm_bytes2words::thread_ap_NS_fsm() {
    switch (ap_CS_fsm.read().to_uint64()) {
        case 1 : 
            ...
            break;
        case 2 : 
            if (!esl_seteq<1,1,1>(ap_const_lv1_0, exitcond_i_fu_132_p2.read())) {
                ap_NS_fsm = ap_ST_fsm_state1;
            } else {
