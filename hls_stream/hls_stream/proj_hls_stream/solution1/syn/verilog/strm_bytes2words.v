...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((1'b1 == ap_continue)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state2) & ~(1'b0 == exitcond_i_fu_132_p2))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((((1'b0 == bytes_in_V_0_vld_in) & (1'b1 == bytes_in_V_0_ack_out) & (bytes_in_V_0_state == ap_const_lv2_3)) | ((1'b0 == bytes_in_V_0_vld_in) & (bytes_in_V_0_state == ap_const_lv2_2)))) begin
            bytes_in_V_0_state <= ap_const_lv2_2;
        end else if ((((1'b1 == bytes_in_V_0_vld_in) & (1'b0 == bytes_in_V_0_ack_out) & (bytes_in_V_0_state == ap_const_lv2_3)) | ((1'b0 == bytes_in_V_0_ack_out) & (bytes_in_V_0_state == ap_const_lv2_1)))) begin
            bytes_in_V_0_state <= ap_const_lv2_1;
        end else if ((((1'b1 == bytes_in_V_0_vld_in) & (bytes_in_V_0_state == ap_const_lv2_2)) | ((1'b1 == bytes_in_V_0_ack_out) & (bytes_in_V_0_state == ap_const_lv2_1)) | ((bytes_in_V_0_state == ap_const_lv2_3) & ~((1'b1 == bytes_in_V_0_vld_in) & (1'b0 == bytes_in_V_0_ack_out)) & ~((1'b0 == bytes_in_V_0_vld_in) & (1'b1 == bytes_in_V_0_ack_out))))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state3) & ~(ap_condition_145 == 1'b1))) begin
        i_i_reg_117 <= i_reg_184;
    end else if (((ap_CS_fsm_state1 == 1'b1) & ~(ap_condition_123 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((ap_CS_fsm_state1 == 1'b1) & ~(ap_condition_123 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state2) & (1'b0 == exitcond_i_fu_132_p2))) begin
        tmp_1_i_reg_189 <= tmp_1_i_fu_143_p2;
    end
end

always @ (*) begin
    if (((1'b1 == ap_done_reg) | ((1'b1 == ap_CS_fsm_state2) & ~(1'b0 == exitcond_i_fu_132_p2)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        bytes_in_V_TDATA_blk_n = bytes_in_V_0_state[1'b0];
    end else begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state3) & ~(1'b0 == tmp_1_i_reg_189))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state3) & ~(1'b0 == tmp_1_i_reg_189) & ~(ap_condition_145 == 1'b1))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ap_ST_fsm_state1 : begin
            if (~(ap_condition_123 == 1'b1)) begin
        ...
        ap_ST_fsm_state2 : begin
            if (~(1'b0 == exitcond_i_fu_132_p2)) begin
                ap_NS_fsm = ap_ST_fsm_state1;
            end else begin
...
always @ (*) begin
    ap_condition_123 = ((ap_start == 1'b0) | (ap_done_reg == 1'b1) | (bytestrm_len_empty_n == 1'b0));
end

always @ (*) begin
    ap_condition_145 = ((bytes_in_V_0_vld_out == 1'b0) | (~(1'b0 == tmp_1_i_reg_189) & (words_out_V_full_n == 1'b0)));
end

assign bytes_in_V_0_ack_in = bytes_in_V_0_state[1'b1];
...
assign bytes_in_V_0_state_cmp_full = ((bytes_in_V_0_state != ap_const_lv2_1) ? 1'b1 : 1'b0);

assign bytes_in_V_0_vld_in = bytes_in_V_TVALID;

assign bytes_in_V_0_vld_out = bytes_in_V_0_state[1'b0];

assign bytes_in_V_TREADY = bytes_in_V_0_state[1'b1];

assign exitcond_i_fu_132_p2 = ((i_i_reg_117 == bytestrm_len_read_reg_176) ? 1'b1 : 1'b0);

assign i_fu_137_p2 = (ap_const_lv16_1 + i_i_reg_117);

assign phitmp_cast_i_fu_168_p3 = {{bytes_in_V_0_data_out}, {tmp_5_fu_158_p4}};

assign tmp_1_i_fu_143_p2 = ((tmp_fu_128_p1 == ap_const_lv2_3) ? 1'b1 : 1'b0);

assign tmp_5_fu_158_p4 = {{r_V_reg_105[ap_const_lv32_17 : ap_const_lv32_8]}};
