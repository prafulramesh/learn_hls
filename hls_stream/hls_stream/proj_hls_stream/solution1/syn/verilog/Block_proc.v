...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((1'b1 == ap_continue)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state1) & ~((1'b0 == real_start) | (1'b0 == strm_len_empty_n) | (1'b0 == bytes_out_len_out_out_full_n) | (ap_done_reg == 1'b1)))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b1 == ap_CS_fsm_state1) & ~((1'b0 == real_start) | (1'b0 == strm_len_empty_n) | (1'b0 == bytes_out_len_out_out_full_n) | (ap_done_reg == 1'b1)))) begin
...
always @ (*) begin
    ap_block_state1 = ((1'b0 == real_start) | (1'b0 == strm_len_empty_n) | (1'b0 == bytes_out_len_out_out_full_n) | (ap_done_reg == 1'b1));
end
