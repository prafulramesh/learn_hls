...
(* CORE_GENERATION_INFO="bytestrm_dwordproc,hls_ip_2017_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7k160tfbg484-1,HLS_INPUT_CLOCK=5.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=4.332500,HLS_SYN_LAT=1490,HLS_SYN_TPT=1490,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=676,HLS_SYN_LUT=693}" *)
...
wire    bytestrm_dwordproc_e_U0_start_full_n;
...
fifo_w16_d1_A strm_len_channel_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
fifo_w16_d1_A strm_len_channel2_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
fifo_w14_d2_A bytes_out_len_loc_ch_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
fifo_w32_d1_A dwordstrm_out_V_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_sync_ready) & (bytestrm_dwordproc_e_U0_ap_ready == 1'b0))) begin
...
always @ (posedge ap_clk) begin
    if (((strm_bytes2words_U0_ap_ready == 1'b0) & (1'b1 == ap_sync_ready))) begin
        strm_bytes2words_U0_ap_ready_count <= (strm_bytes2words_U0_ap_ready_count - 2'd1);
    end else if (((1'b1 == strm_bytes2words_U0_ap_ready) & (ap_sync_ready == 1'b0))) begin
        strm_bytes2words_U0_ap_ready_count <= (strm_bytes2words_U0_ap_ready_count + 2'd1);
    end
end
...
assign Block_proc_U0_start_full_n = (1'b0 | start_for_strm_words2bytes_U0_full_n);
...
assign bytestrm_dwordproc_e_U0_ap_start = (ap_start & (ap_sync_reg_bytestrm_dwordproc_e_U0_ap_ready ^ 1'b1));

assign bytestrm_dwordproc_e_U0_start_full_n = (1'b0 | start_for_Block_proc_U0_full_n);

assign decimate_strm_U0_ap_continue = 1'b1;

assign decimate_strm_U0_ap_start = dwords_in_len_cast_l_empty_n;

assign decimate_strm_U0_start_full_n = 1'b0;
...
assign strm_bytes2words_U0_ap_start = (ap_start & (ap_sync_reg_strm_bytes2words_U0_ap_ready ^ 1'b1));

assign strm_bytes2words_U0_start_full_n = 1'b0;
...
assign strm_words2bytes_U0_start_full_n = 1'b0;
