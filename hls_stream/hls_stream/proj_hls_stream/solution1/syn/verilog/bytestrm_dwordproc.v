...
(* CORE_GENERATION_INFO="bytestrm_dwordproc,hls_ip_2016_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7k160tfbg484-1,HLS_INPUT_CLOCK=5.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=3.760000,HLS_SYN_LAT=1490,HLS_SYN_TPT=1490,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=314,HLS_SYN_LUT=536}" *)
...
wire    ap_hs_continue;
wire    strm_len_channel_full_n;
wire   [15:0] strm_len_channel_dout;
wire    strm_len_channel_empty_n;
wire    strm_len_channel2_full_n;
wire   [15:0] strm_len_channel2_dout;
wire    strm_len_channel2_empty_n;
wire    bytes_out_len_loc_ch_full_n;
wire   [13:0] bytes_out_len_loc_ch_dout;
wire    bytes_out_len_loc_ch_empty_n;
...
wire    ap_sync_strm_bytes2words_U0_ap_start;
wire    ap_sync_bytestrm_dwordproc_e_U0_ap_start;
...
#0 strm_bytes2words_U0_ap_ready_count = 2'b00;
#0 ap_sync_reg_bytestrm_dwordproc_e_U0_ap_ready = 1'b0;
#0 bytestrm_dwordproc_e_U0_ap_ready_count = 2'b00;
end
...
bytestrm_dwordprobkb strm_len_channel_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bytestrm_dwordprocud strm_len_channel2_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bytestrm_dwordprodEe bytes_out_len_loc_ch_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bytestrm_dwordproeOg dwords_in_len_cast_l_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bytestrm_dwordprofYi dwordstrm_in_V_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bytestrm_dwordprog8j dwordstrm_out_V_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
start_for_strm_woibs start_for_strm_woibs_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_hs_ready) & (bytestrm_dwordproc_e_U0_ap_ready == 1'b0))) begin
        bytestrm_dwordproc_e_U0_ap_ready_count <= (bytestrm_dwordproc_e_U0_ap_ready_count - ap_const_lv2_1);
    end else if (((ap_hs_ready == 1'b0) & (bytestrm_dwordproc_e_U0_ap_ready == 1'b1))) begin
        bytestrm_dwordproc_e_U0_ap_ready_count <= (bytestrm_dwordproc_e_U0_ap_ready_count + ap_const_lv2_1);
    end
end

always @ (posedge ap_clk) begin
    if (((strm_bytes2words_U0_ap_ready == 1'b0) & (1'b1 == ap_hs_ready))) begin
        strm_bytes2words_U0_ap_ready_count <= (strm_bytes2words_U0_ap_ready_count - ap_const_lv2_1);
    end else if (((1'b1 == strm_bytes2words_U0_ap_ready) & (ap_hs_ready == 1'b0))) begin
        strm_bytes2words_U0_ap_ready_count <= (strm_bytes2words_U0_ap_ready_count + ap_const_lv2_1);
    end
end
...
assign ap_hs_done = strm_words2bytes_U0_ap_done;

assign ap_hs_ready = (ap_sync_strm_bytes2words_U0_ap_ready & ap_sync_bytestrm_dwordproc_e_U0_ap_ready);

assign ap_idle = (bytestrm_dwordproc_e_U0_ap_idle & Block_proc_U0_ap_idle & strm_bytes2words_U0_ap_idle & decimate_strm_U0_ap_idle & strm_words2bytes_U0_ap_idle & (dwords_in_len_cast_l_empty_n ^ 1'b1));
...
assign ap_sync_bytestrm_dwordproc_e_U0_ap_start = (ap_start & (ap_sync_reg_bytestrm_dwordproc_e_U0_ap_ready ^ 1'b1));

assign ap_sync_strm_bytes2words_U0_ap_ready = (strm_bytes2words_U0_ap_ready | ap_sync_reg_strm_bytes2words_U0_ap_ready);

assign ap_sync_strm_bytes2words_U0_ap_start = (ap_start & (ap_sync_reg_strm_bytes2words_U0_ap_ready ^ 1'b1));

assign bytestrm_dwordproc_e_U0_ap_continue = 1'b1;

assign bytestrm_dwordproc_e_U0_ap_start = ap_sync_bytestrm_dwordproc_e_U0_ap_start;
...
assign strm_bytes2words_U0_ap_start = ap_sync_strm_bytes2words_U0_ap_start;
