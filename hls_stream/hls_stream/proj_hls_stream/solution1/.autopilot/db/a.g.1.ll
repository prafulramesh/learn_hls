; ModuleID = '/home/praful/Documents/learn_hls/hls_stream/hls_stream/proj_hls_stream/solution1/.autopilot/db/a.g.1.bc'
...
define internal fastcc void @"strm_words2bytes<int, (unsigned char)4, false>"(%"class.hls::stream.24"* %bytes_out, %"class.hls::stream.0.25"* %words_in, i16 zeroext %bytestrm_len) nounwind uwtable {
  ...
  call void @llvm.dbg.value(metadata !{%"class.hls::stream.24"* %bytes_out}, i64 0, metadata !4139), !dbg !4140 ; [debug line = 134:29] [debug variable = bytes_out]
  call void @llvm.dbg.value(metadata !{%"class.hls::stream.0.25"* %words_in}, i64 0, metadata !4141), !dbg !4142 ; [debug line = 135:23] [debug variable = words_in]
  call void @llvm.dbg.value(metadata !{i16 %bytestrm_len}, i64 0, metadata !4143), !dbg !4144 ; [debug line = 136:16] [debug variable = bytestrm_len]
  %tmp = zext i16 %bytestrm_len to i32            ; [#uses=1 type=i32]
  %words_in.addr = getelementptr inbounds %"class.hls::stream.0.25"* %words_in, i64 0, i32 0, !dbg !4145 ; [#uses=1 type=i32*] [debug line = 125:9@146:10]
  %bytes_out.addr = getelementptr inbounds %"class.hls::stream.24"* %bytes_out, i64 0, i32 0, !dbg !4152 ; [#uses=1 type=i8*] [debug line = 146:9@156:7]
  br label %1, !dbg !4155                         ; [debug line = 143:18]
...
; <label>:1                                       ; preds = %_ZrSILi32ELb0EER11ap_int_baseIXT_EXT0_EXleT_Li64EEES2_i.exit, %0
  ...
  %exitcond = icmp eq i32 %i, %tmp, !dbg !4155    ; [#uses=1 type=i1] [debug line = 143:18]
  br i1 %exitcond, label %4, label %2, !dbg !4155 ; [debug line = 143:18]

; <label>:2                                       ; preds = %1
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([17 x i8]* @.str3, i64 0, i64 0)) nounwind, !dbg !4156 ; [debug line = 143:49]
  %rbegin = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([17 x i8]* @.str3, i64 0, i64 0)) nounwind, !dbg !4156 ; [#uses=1 type=i32] [debug line = 143:49]
  call void (...)* @_ssdm_op_SpecLoopTripCount(i32 0, i32 372, i32 186, i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0)) nounwind, !dbg !4157 ; [debug line = 144:1]
  %tmp.1 = and i32 %i, 3, !dbg !4158              ; [#uses=1 type=i32] [debug line = 145:2]
  %tmp.2 = icmp eq i32 %tmp.1, 0, !dbg !4158      ; [#uses=1 type=i1] [debug line = 145:2]
  br i1 %tmp.2, label %3, label %_ZrSILi32ELb0EER11ap_int_baseIXT_EXT0_EXleT_Li64EEES2_i.exit, !dbg !4158 ; [debug line = 145:2]

; <label>:3                                       ; preds = %2
  call void @llvm.dbg.value(metadata !{%"class.hls::stream.0.25"* %words_in}, i64 0, metadata !4159), !dbg !4161 ; [debug line = 123:48@146:10] [debug variable = this]
  call void @llvm.dbg.declare(metadata !{i32* %tmp.3}, metadata !4162) nounwind, !dbg !4163 ; [debug line = 124:22@146:10] [debug variable = tmp]
  call void @_ssdm_op_IfRead.Stream.i32P.i32P(i32* %words_in.addr, i32* %tmp.3) nounwind, !dbg !4145 ; [debug line = 125:9@146:10]
  call void @llvm.dbg.value(metadata !{i32* %tmp.3}, i64 0, metadata !4162), !dbg !4164 ; [debug line = 126:9@146:10] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i32* %tmp.3}, i64 0, metadata !4162), !dbg !4164 ; [debug line = 126:9@146:10] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i32* %tmp.3}, i64 0, metadata !4162), !dbg !4164 ; [debug line = 126:9@146:10] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i32* %tmp.3}, i64 0, metadata !4162), !dbg !4164 ; [debug line = 126:9@146:10] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i32* %tmp.3}, i64 0, metadata !4162), !dbg !4164 ; [debug line = 126:9@146:10] [debug variable = tmp]
  ...
  call void @llvm.dbg.value(metadata !{i32* %tmp.3}, i64 0, metadata !4162), !dbg !4164 ; [debug line = 126:9@146:10] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i32* %tmp.3}, i64 0, metadata !4162), !dbg !4164 ; [debug line = 126:9@146:10] [debug variable = tmp]
  %inval = load i32* %tmp.3, align 4, !dbg !4164  ; [#uses=1 type=i32] [debug line = 126:9@146:10]
  call void @llvm.dbg.value(metadata !{i32 %inval}, i64 0, metadata !4165), !dbg !4164 ; [debug line = 126:9@146:10] [debug variable = inval]
  call void @llvm.dbg.value(metadata !{i32 %inval}, i64 0, metadata !4166), !dbg !4167 ; [debug line = 250:55@147:10] [debug variable = val]
  call void @llvm.dbg.value(metadata !{i32 %inval}, i64 0, metadata !4169), !dbg !4170 ; [debug line = 250:55@250:77@147:10] [debug variable = val]
  call void @llvm.dbg.value(metadata !{i32 %inval}, i64 0, metadata !4172), !dbg !4180 ; [debug line = 277:10@147:10] [debug variable = tmpword.V]
  br label %_ZrSILi32ELb0EER11ap_int_baseIXT_EXT0_EXleT_Li64EEES2_i.exit, !dbg !4182 ; [debug line = 148:7]

_ZrSILi32ELb0EER11ap_int_baseIXT_EXT0_EXleT_Li64EEES2_i.exit: ; preds = %3, %2
  %.0.1 = phi i32 [ %inval, %3 ], [ %.0, %2 ]     ; [#uses=2 type=i32]
  %tmpbyte = trunc i32 %.0.1 to i8, !dbg !4183    ; [#uses=1 type=i8] [debug line = 150:28]
  call void @llvm.dbg.value(metadata !{i8 %tmpbyte}, i64 0, metadata !4185), !dbg !4183 ; [debug line = 150:28] [debug variable = tmpbyte]
  %tmpword.V.1 = lshr i32 %.0.1, 8, !dbg !4187    ; [#uses=1 type=i32] [debug line = 1959:21@1955:16@3526:0@151:10]
  call void @llvm.dbg.value(metadata !{i32 %tmpword.V.1}, i64 0, metadata !4172), !dbg !4187 ; [debug line = 1959:21@1955:16@3526:0@151:10] [debug variable = tmpword.V]
  call void @llvm.dbg.value(metadata !{i32 %tmpword.V.1}, i64 0, metadata !4172), !dbg !4194 ; [debug line = 1951:9@3526:0@151:10] [debug variable = tmpword.V]
  call void @llvm.dbg.value(metadata !{%"class.hls::stream.24"* %bytes_out}, i64 0, metadata !4195), !dbg !4197 ; [debug line = 144:48@156:7] [debug variable = this]
  call void @llvm.dbg.declare(metadata !{i8* %tmp.5}, metadata !4198) nounwind, !dbg !4199 ; [debug line = 145:22@156:7] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i8 %tmpbyte}, i64 0, metadata !4198), !dbg !4200 ; [debug line = 145:31@156:7] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i8 %tmpbyte}, i64 0, metadata !4198), !dbg !4200 ; [debug line = 145:31@156:7] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i8 %tmpbyte}, i64 0, metadata !4198), !dbg !4200 ; [debug line = 145:31@156:7] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i8 %tmpbyte}, i64 0, metadata !4198), !dbg !4200 ; [debug line = 145:31@156:7] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i8 %tmpbyte}, i64 0, metadata !4198), !dbg !4200 ; [debug line = 145:31@156:7] [debug variable = tmp]
  ...
  call void @llvm.dbg.value(metadata !{i8 %tmpbyte}, i64 0, metadata !4198), !dbg !4200 ; [debug line = 145:31@156:7] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i8 %tmpbyte}, i64 0, metadata !4198), !dbg !4200 ; [debug line = 145:31@156:7] [debug variable = tmp]
  store i8 %tmpbyte, i8* %tmp.5, align 1, !dbg !4200 ; [debug line = 145:31@156:7]
  call void @_ssdm_op_IfWrite.Stream.i8P.i8P(i8* %bytes_out.addr, i8* %tmp.5) nounwind, !dbg !4152 ; [debug line = 146:9@156:7]
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([17 x i8]* @.str3, i64 0, i64 0), i32 %rbegin) nounwind, !dbg !4201 ; [#uses=0 type=i32] [debug line = 157:4]
  %i.1 = add nsw i32 %i, 1, !dbg !4202            ; [#uses=1 type=i32] [debug line = 143:43]
  call void @llvm.dbg.value(metadata !{i32 %i.1}, i64 0, metadata !4203), !dbg !4202 ; [debug line = 143:43] [debug variable = i]
  br label %1, !dbg !4202                         ; [debug line = 143:43]

; <label>:4                                       ; preds = %1
  ret void, !dbg !4204                            ; [debug line = 158:1]
}
...
define internal fastcc void @"strm_bytes2words<int, (unsigned char)4, false>"(%"class.hls::stream.0.25"* %words_out, %"class.hls::stream.24"* %bytes_in, i16 zeroext %bytestrm_len) nounwind uwtable {
  ...
  call void @llvm.dbg.value(metadata !{%"class.hls::stream.0.25"* %words_out}, i64 0, metadata !4205), !dbg !4206 ; [debug line = 108:23] [debug variable = words_out]
  call void @llvm.dbg.value(metadata !{%"class.hls::stream.24"* %bytes_in}, i64 0, metadata !4207), !dbg !4208 ; [debug line = 109:29] [debug variable = bytes_in]
  call void @llvm.dbg.value(metadata !{i16 %bytestrm_len}, i64 0, metadata !4209), !dbg !4210 ; [debug line = 110:16] [debug variable = bytestrm_len]
  %tmp = zext i16 %bytestrm_len to i32            ; [#uses=1 type=i32]
  %bytes_in.addr = getelementptr inbounds %"class.hls::stream.24"* %bytes_in, i64 0, i32 0, !dbg !4211 ; [#uses=1 type=i8*] [debug line = 125:9@118:2]
  %words_out.addr = getelementptr inbounds %"class.hls::stream.0.25"* %words_out, i64 0, i32 0, !dbg !4217 ; [#uses=1 type=i32*] [debug line = 146:9@126:28]
  br label %1, !dbg !4220                         ; [debug line = 116:18]

; <label>:1                                       ; preds = %_ZrsILi32ELb0EE11ap_int_baseIXT_EXT0_EXleT_Li64EEERKS1_i.exit._crit_edge, %0
  %r.V = phi i32 [ 0, %0 ], [ %phitmp, %_ZrsILi32ELb0EE11ap_int_baseIXT_EXT0_EXleT_Li64EEERKS1_i.exit._crit_edge ], !dbg !4221 ; [#uses=1 type=i32] [debug line = 3526:0@120:21]
  %i = phi i32 [ 0, %0 ], [ %i.2, %_ZrsILi32ELb0EE11ap_int_baseIXT_EXT0_EXleT_Li64EEERKS1_i.exit._crit_edge ] ; [#uses=3 type=i32]
  %exitcond = icmp eq i32 %i, %tmp, !dbg !4220    ; [#uses=1 type=i1] [debug line = 116:18]
  br i1 %exitcond, label %3, label %_ZrsILi32ELb0EE11ap_int_baseIXT_EXT0_EXleT_Li64EEERKS1_i.exit, !dbg !4220 ; [debug line = 116:18]

_ZrsILi32ELb0EE11ap_int_baseIXT_EXT0_EXleT_Li64EEERKS1_i.exit: ; preds = %1
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([17 x i8]* @.str4, i64 0, i64 0)) nounwind, !dbg !4225 ; [debug line = 116:49]
  %rbegin = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([17 x i8]* @.str4, i64 0, i64 0)) nounwind, !dbg !4225 ; [#uses=1 type=i32] [debug line = 116:49]
  call void (...)* @_ssdm_op_SpecLoopTripCount(i32 0, i32 1488, i32 744, i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0)) nounwind, !dbg !4226 ; [debug line = 117:1]
  call void @llvm.dbg.value(metadata !{%"class.hls::stream.24"* %bytes_in}, i64 0, metadata !4227), !dbg !4228 ; [debug line = 123:48@118:2] [debug variable = this]
  call void @llvm.dbg.declare(metadata !{i8* %tmp.8}, metadata !4229) nounwind, !dbg !4230 ; [debug line = 124:22@118:2] [debug variable = tmp]
  call void @_ssdm_op_IfRead.Stream.i8P.i8P(i8* %bytes_in.addr, i8* %tmp.8) nounwind, !dbg !4211 ; [debug line = 125:9@118:2]
  call void @llvm.dbg.value(metadata !{i8* %tmp.8}, i64 0, metadata !4229), !dbg !4231 ; [debug line = 126:9@118:2] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i8* %tmp.8}, i64 0, metadata !4229), !dbg !4231 ; [debug line = 126:9@118:2] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i8* %tmp.8}, i64 0, metadata !4229), !dbg !4231 ; [debug line = 126:9@118:2] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i8* %tmp.8}, i64 0, metadata !4229), !dbg !4231 ; [debug line = 126:9@118:2] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i8* %tmp.8}, i64 0, metadata !4229), !dbg !4231 ; [debug line = 126:9@118:2] [debug variable = tmp]
  ...
  call void @llvm.dbg.value(metadata !{i8* %tmp.8}, i64 0, metadata !4229), !dbg !4231 ; [debug line = 126:9@118:2] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i8* %tmp.8}, i64 0, metadata !4229), !dbg !4231 ; [debug line = 126:9@118:2] [debug variable = tmp]
  %tmpbyte = load i8* %tmp.8, align 1, !dbg !4231 ; [#uses=1 type=i8] [debug line = 126:9@118:2]
  call void @llvm.dbg.value(metadata !{i8 %tmpbyte}, i64 0, metadata !4232), !dbg !4231 ; [debug line = 126:9@118:2] [debug variable = tmpbyte]
  call void @llvm.dbg.value(metadata !{i32 %r.V}, i64 0, metadata !4233), !dbg !4221 ; [debug line = 3526:0@120:21] [debug variable = r.V]
  call void @llvm.dbg.value(metadata !{i8 %tmpbyte}, i64 0, metadata !4235), !dbg !4236 ; [debug line = 247:65@121:14] [debug variable = val]
  call void @llvm.dbg.value(metadata !{i8 %tmpbyte}, i64 0, metadata !4238), !dbg !4239 ; [debug line = 247:65@247:87@121:14] [debug variable = val]
  %.034 = zext i8 %tmpbyte to i32, !dbg !4241     ; [#uses=1 type=i32] [debug line = 247:72@247:87@121:14]
  %r.V.2 = shl nuw i32 %.034, 24, !dbg !4243      ; [#uses=1 type=i32] [debug line = 3526:0@121:14]
  call void @llvm.dbg.value(metadata !{i32 %r.V.2}, i64 0, metadata !4245), !dbg !4243 ; [debug line = 3526:0@121:14] [debug variable = r.V]
  call void @llvm.dbg.value(metadata !{i32 %r.V}, i64 0, metadata !4247), !dbg !4250 ; [debug line = 3375:0@121:14] [debug variable = lhs.V]
  call void @llvm.dbg.value(metadata !{i32 %r.V.2}, i64 0, metadata !4251), !dbg !4250 ; [debug line = 3375:0@121:14] [debug variable = rhs.V]
  %r.V.3 = or i32 %r.V.2, %r.V, !dbg !4250        ; [#uses=2 type=i32] [debug line = 3375:0@121:14]
  call void @llvm.dbg.value(metadata !{i32 %r.V.3}, i64 0, metadata !4253), !dbg !4250 ; [debug line = 3375:0@121:14] [debug variable = r.V]
  call void @llvm.dbg.value(metadata !{i32 %r.V.3}, i64 0, metadata !4256), !dbg !4258 ; [debug line = 277:10@121:14] [debug variable = tmpword.V]
  %tmp.10 = srem i32 %i, 4, !dbg !4259            ; [#uses=1 type=i32] [debug line = 125:7]
  %tmp.11 = icmp eq i32 %tmp.10, 3, !dbg !4259    ; [#uses=1 type=i1] [debug line = 125:7]
  br i1 %tmp.11, label %2, label %_ZrsILi32ELb0EE11ap_int_baseIXT_EXT0_EXleT_Li64EEERKS1_i.exit._crit_edge, !dbg !4259 ; [debug line = 125:7]

; <label>:2                                       ; preds = %_ZrsILi32ELb0EE11ap_int_baseIXT_EXT0_EXleT_Li64EEERKS1_i.exit
  call void @llvm.dbg.value(metadata !{%"class.hls::stream.0.25"* %words_out}, i64 0, metadata !4260), !dbg !4261 ; [debug line = 144:48@126:28] [debug variable = this]
  call void @llvm.dbg.declare(metadata !{i32* %tmp.12}, metadata !4262) nounwind, !dbg !4263 ; [debug line = 145:22@126:28] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i32 %r.V.3}, i64 0, metadata !4262), !dbg !4264 ; [debug line = 145:31@126:28] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i32 %r.V.3}, i64 0, metadata !4262), !dbg !4264 ; [debug line = 145:31@126:28] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i32 %r.V.3}, i64 0, metadata !4262), !dbg !4264 ; [debug line = 145:31@126:28] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i32 %r.V.3}, i64 0, metadata !4262), !dbg !4264 ; [debug line = 145:31@126:28] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i32 %r.V.3}, i64 0, metadata !4262), !dbg !4264 ; [debug line = 145:31@126:28] [debug variable = tmp]
  ...
  call void @llvm.dbg.value(metadata !{i32 %r.V.3}, i64 0, metadata !4262), !dbg !4264 ; [debug line = 145:31@126:28] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i32 %r.V.3}, i64 0, metadata !4262), !dbg !4264 ; [debug line = 145:31@126:28] [debug variable = tmp]
  store i32 %r.V.3, i32* %tmp.12, align 4, !dbg !4264 ; [debug line = 145:31@126:28]
  call void @_ssdm_op_IfWrite.Stream.i32P.i32P(i32* %words_out.addr, i32* %tmp.12) nounwind, !dbg !4217 ; [debug line = 146:9@126:28]
  br label %_ZrsILi32ELb0EE11ap_int_baseIXT_EXT0_EXleT_Li64EEERKS1_i.exit._crit_edge, !dbg !4219 ; [debug line = 126:28]
...
_ZrsILi32ELb0EE11ap_int_baseIXT_EXT0_EXleT_Li64EEERKS1_i.exit._crit_edge: ; preds = %2, %_ZrsILi32ELb0EE11ap_int_baseIXT_EXT0_EXleT_Li64EEERKS1_i.exit
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([17 x i8]* @.str4, i64 0, i64 0), i32 %rbegin) nounwind, !dbg !4265 ; [#uses=0 type=i32] [debug line = 127:4]
  %i.2 = add nsw i32 %i, 1, !dbg !4266            ; [#uses=1 type=i32] [debug line = 116:43]
  call void @llvm.dbg.value(metadata !{i32 %i.2}, i64 0, metadata !4267), !dbg !4266 ; [debug line = 116:43] [debug variable = i]
  %phitmp = lshr i32 %r.V.3, 8, !dbg !4266        ; [#uses=1 type=i32] [debug line = 116:43]
  br label %1, !dbg !4266                         ; [debug line = 116:43]

; <label>:3                                       ; preds = %1
  ret void, !dbg !4268                            ; [debug line = 128:1]
}
...
define internal fastcc void @decimate_strm(%"class.hls::stream.0.25"* %strm_out, %"class.hls::stream.0.25"* %strm_in, i16 zeroext %strm_len) nounwind uwtable {
  ...
  call void @llvm.dbg.value(metadata !{%"class.hls::stream.0.25"* %strm_out}, i64 0, metadata !4269), !dbg !4270 ; [debug line = 135:24] [debug variable = strm_out]
  call void @llvm.dbg.value(metadata !{%"class.hls::stream.0.25"* %strm_in}, i64 0, metadata !4271), !dbg !4272 ; [debug line = 136:24] [debug variable = strm_in]
  call void @llvm.dbg.value(metadata !{i16 %strm_len}, i64 0, metadata !4273), !dbg !4274 ; [debug line = 137:16] [debug variable = strm_len]
  %tmp = zext i16 %strm_len to i32, !dbg !4275    ; [#uses=1 type=i32] [debug line = 143:9]
  %tmp.15 = lshr i32 %tmp, 2, !dbg !4275          ; [#uses=1 type=i32] [debug line = 143:9]
  %strm_in.addr = getelementptr inbounds %"class.hls::stream.0.25"* %strm_in, i64 0, i32 0, !dbg !4278 ; [#uses=1 type=i32*] [debug line = 131:9@149:9]
  %strm_out.addr = getelementptr inbounds %"class.hls::stream.0.25"* %strm_out, i64 0, i32 0, !dbg !4284 ; [#uses=1 type=i32*] [debug line = 146:9@106:9@153:13]
  br label %1, !dbg !4275                         ; [debug line = 143:9]

; <label>:1                                       ; preds = %6, %0
  %i = phi i32 [ 0, %0 ], [ %i.3, %6 ]            ; [#uses=2 type=i32]
  %tmp.16 = icmp ult i32 %i, %tmp.15, !dbg !4275  ; [#uses=1 type=i1] [debug line = 143:9]
  br i1 %tmp.16, label %2, label %7, !dbg !4275   ; [debug line = 143:9]

; <label>:2                                       ; preds = %1
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([12 x i8]* @.str5, i64 0, i64 0)) nounwind, !dbg !4288 ; [debug line = 143:40]
  %rbegin3 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([12 x i8]* @.str5, i64 0, i64 0)) nounwind, !dbg !4288 ; [#uses=1 type=i32] [debug line = 143:40]
  call void (...)* @_ssdm_op_SpecLoopTripCount(i32 0, i32 93, i32 46, i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0)) nounwind, !dbg !4289 ; [debug line = 144:1]
  br label %3, !dbg !4290                         ; [debug line = 147:12]

; <label>:3                                       ; preds = %._crit_edge, %2
  %j = phi i32 [ 0, %2 ], [ %j.1, %._crit_edge ]  ; [#uses=3 type=i32]
  %acc = phi i64 [ 0, %2 ], [ %acc.1, %._crit_edge ] ; [#uses=1 type=i64]
  %tmp.17 = icmp eq i32 %j, 4, !dbg !4290         ; [#uses=1 type=i1] [debug line = 147:12]
  br i1 %tmp.17, label %6, label %4, !dbg !4290   ; [debug line = 147:12]

; <label>:4                                       ; preds = %3
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([14 x i8]* @.str6, i64 0, i64 0)) nounwind, !dbg !4291 ; [debug line = 147:32]
  %rbegin = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([14 x i8]* @.str6, i64 0, i64 0)) nounwind, !dbg !4291 ; [#uses=1 type=i32] [debug line = 147:32]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0)) nounwind, !dbg !4292 ; [debug line = 148:1]
  call void @llvm.dbg.value(metadata !{%"class.hls::stream.0.25"* %strm_in}, i64 0, metadata !4293), !dbg !4294 ; [debug line = 129:56@149:9] [debug variable = this]
  call void @llvm.dbg.declare(metadata !{i32* %tmp.19}, metadata !4295) nounwind, !dbg !4296 ; [debug line = 130:22@149:9] [debug variable = tmp]
  call void @_ssdm_op_IfRead.Stream.i32P.i32P(i32* %strm_in.addr, i32* %tmp.19) nounwind, !dbg !4278 ; [debug line = 131:9@149:9]
  call void @llvm.dbg.value(metadata !{i32* %tmp.19}, i64 0, metadata !4295), !dbg !4297 ; [debug line = 132:9@149:9] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i32* %tmp.19}, i64 0, metadata !4295), !dbg !4297 ; [debug line = 132:9@149:9] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i32* %tmp.19}, i64 0, metadata !4295), !dbg !4297 ; [debug line = 132:9@149:9] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i32* %tmp.19}, i64 0, metadata !4295), !dbg !4297 ; [debug line = 132:9@149:9] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i32* %tmp.19}, i64 0, metadata !4295), !dbg !4297 ; [debug line = 132:9@149:9] [debug variable = tmp]
  ...
  call void @llvm.dbg.value(metadata !{i32* %tmp.19}, i64 0, metadata !4295), !dbg !4297 ; [debug line = 132:9@149:9] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i32* %tmp.19}, i64 0, metadata !4295), !dbg !4297 ; [debug line = 132:9@149:9] [debug variable = tmp]
  %tmp.19.load = load i32* %tmp.19, align 4, !dbg !4297 ; [#uses=1 type=i32] [debug line = 132:9@149:9]
  %tmp.20 = sext i32 %tmp.19.load to i64, !dbg !4280 ; [#uses=1 type=i64] [debug line = 149:9]
  %acc.1 = add nsw i64 %tmp.20, %acc, !dbg !4280  ; [#uses=2 type=i64] [debug line = 149:9]
  call void @llvm.dbg.value(metadata !{i64 %acc.1}, i64 0, metadata !4298), !dbg !4280 ; [debug line = 149:9] [debug variable = acc]
  %tmp.22 = icmp eq i32 %j, 3, !dbg !4300         ; [#uses=1 type=i1] [debug line = 152:10]
  br i1 %tmp.22, label %5, label %._crit_edge, !dbg !4300 ; [debug line = 152:10]

; <label>:5                                       ; preds = %4
  %tmp.23 = lshr i64 %acc.1, 2, !dbg !4287        ; [#uses=1 type=i64] [debug line = 153:13]
  %tmp.25 = trunc i64 %tmp.23 to i32, !dbg !4287  ; [#uses=1 type=i32] [debug line = 153:13]
  call void @llvm.dbg.value(metadata !{%"class.hls::stream.0.25"* %strm_out}, i64 0, metadata !4301), !dbg !4302 ; [debug line = 105:48@153:13] [debug variable = this]
  call void @llvm.dbg.value(metadata !{%"class.hls::stream.0.25"* %strm_out}, i64 0, metadata !4260), !dbg !4303 ; [debug line = 144:48@106:9@153:13] [debug variable = this]
  call void @llvm.dbg.declare(metadata !{i32* %tmp.24}, metadata !4262) nounwind, !dbg !4304 ; [debug line = 145:22@106:9@153:13] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i32 %tmp.25}, i64 0, metadata !4262), !dbg !4305 ; [debug line = 145:31@106:9@153:13] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i32 %tmp.25}, i64 0, metadata !4262), !dbg !4305 ; [debug line = 145:31@106:9@153:13] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i32 %tmp.25}, i64 0, metadata !4262), !dbg !4305 ; [debug line = 145:31@106:9@153:13] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i32 %tmp.25}, i64 0, metadata !4262), !dbg !4305 ; [debug line = 145:31@106:9@153:13] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i32 %tmp.25}, i64 0, metadata !4262), !dbg !4305 ; [debug line = 145:31@106:9@153:13] [debug variable = tmp]
  ...
  call void @llvm.dbg.value(metadata !{i32 %tmp.25}, i64 0, metadata !4262), !dbg !4305 ; [debug line = 145:31@106:9@153:13] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i32 %tmp.25}, i64 0, metadata !4262), !dbg !4305 ; [debug line = 145:31@106:9@153:13] [debug variable = tmp]
  store i32 %tmp.25, i32* %tmp.24, align 4, !dbg !4305 ; [debug line = 145:31@106:9@153:13]
  call void @_ssdm_op_IfWrite.Stream.i32P.i32P(i32* %strm_out.addr, i32* %tmp.24) nounwind, !dbg !4284 ; [debug line = 146:9@106:9@153:13]
  br label %._crit_edge, !dbg !4287               ; [debug line = 153:13]

._crit_edge:                                      ; preds = %5, %4
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([14 x i8]* @.str6, i64 0, i64 0), i32 %rbegin) nounwind, !dbg !4306 ; [#uses=0 type=i32] [debug line = 154:7]
  %j.1 = add i32 %j, 1, !dbg !4307                ; [#uses=1 type=i32] [debug line = 147:26]
  call void @llvm.dbg.value(metadata !{i32 %j.1}, i64 0, metadata !4308), !dbg !4307 ; [debug line = 147:26] [debug variable = j]
  br label %3, !dbg !4307                         ; [debug line = 147:26]

; <label>:6                                       ; preds = %3
  %rend4 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str5, i64 0, i64 0), i32 %rbegin3) nounwind, !dbg !4309 ; [#uses=0 type=i32] [debug line = 155:4]
  %i.3 = add i32 %i, 1, !dbg !4310                ; [#uses=1 type=i32] [debug line = 143:34]
  call void @llvm.dbg.value(metadata !{i32 %i.3}, i64 0, metadata !4311), !dbg !4310 ; [debug line = 143:34] [debug variable = i]
  br label %1, !dbg !4310                         ; [debug line = 143:34]

; <label>:7                                       ; preds = %1
  ret void, !dbg !4312                            ; [debug line = 156:1]
}
...
define void @bytestrm_dwordproc(%"class.hls::stream.24"* %strm_out, %"class.hls::stream.24"* %strm_in, i16 zeroext %strm_len) nounwind uwtable {
  ...
  call void @llvm.dbg.value(metadata !{%"class.hls::stream.24"* %strm_out}, i64 0, metadata !4313), !dbg !4314 ; [debug line = 103:29] [debug variable = strm_out]
  call void @llvm.dbg.value(metadata !{%"class.hls::stream.24"* %strm_in}, i64 0, metadata !4315), !dbg !4316 ; [debug line = 104:29] [debug variable = strm_in]
  call void @llvm.dbg.value(metadata !{i16 %strm_len}, i64 0, metadata !4317), !dbg !4318 ; [debug line = 105:16] [debug variable = strm_len]
  call void (...)* @_ssdm_op_SpecInterface(%"class.hls::stream.24"* %strm_in, i8* getelementptr inbounds ([5 x i8]* @.str, i64 0, i64 0), i32 1, i32 1, i8* getelementptr inbounds ([5 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0)) nounwind, !dbg !4319 ; [debug line = 109:1]
  call void (...)* @_ssdm_op_SpecInterface(%"class.hls::stream.24"* %strm_out, i8* getelementptr inbounds ([5 x i8]* @.str, i64 0, i64 0), i32 1, i32 1, i8* getelementptr inbounds ([5 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0)) nounwind, !dbg !4321 ; [debug line = 110:1]
  call void @llvm.dbg.declare(metadata !{%"class.hls::stream.0.25"* %dwordstrm_in}, metadata !4322), !dbg !4323 ; [debug line = 113:20] [debug variable = dwordstrm_in]
  call void @llvm.dbg.value(metadata !{%"class.hls::stream.0.25"* %dwordstrm_in}, i64 0, metadata !4324), !dbg !4325 ; [debug line = 83:43@113:32] [debug variable = this]
  call void @llvm.dbg.value(metadata !{%"class.hls::stream.0.25"* %dwordstrm_in}, i64 0, metadata !4327), !dbg !4328 ; [debug line = 83:43@84:5@113:32] [debug variable = this]
  call void @llvm.dbg.declare(metadata !{%"class.hls::stream.0.25"* %dwordstrm_out}, metadata !4330), !dbg !4331 ; [debug line = 114:20] [debug variable = dwordstrm_out]
  call void @llvm.dbg.value(metadata !{%"class.hls::stream.0.25"* %dwordstrm_out}, i64 0, metadata !4324), !dbg !4332 ; [debug line = 83:43@114:33] [debug variable = this]
  call void @llvm.dbg.value(metadata !{%"class.hls::stream.0.25"* %dwordstrm_out}, i64 0, metadata !4327), !dbg !4334 ; [debug line = 83:43@84:5@114:33] [debug variable = this]
  call void (...)* @_ssdm_SpecStream(%"class.hls::stream.0.25"* %dwordstrm_in, i32 0, i32 4, i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0)) nounwind, !dbg !4336 ; [debug line = 115:1]
  call void (...)* @_ssdm_op_SpecDataflowPipeline(i32 -1, i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0)) nounwind, !dbg !4337 ; [debug line = 117:1]
  call void @llvm.dbg.value(metadata !{i16 %strm_len}, i64 0, metadata !4338), !dbg !4339 ; [debug line = 120:36] [debug variable = bytes_in_len]
  %dwords_in_len = lshr i16 %strm_len, 2, !dbg !4340 ; [#uses=2 type=i16] [debug line = 121:41]
  call void @llvm.dbg.value(metadata !{i16 %dwords_in_len}, i64 0, metadata !4341), !dbg !4340 ; [debug line = 121:41] [debug variable = dwords_in_len]
  %bytes_out_len = and i16 %dwords_in_len, 16380, !dbg !4342 ; [#uses=1 type=i16] [debug line = 122:52]
  call void @llvm.dbg.value(metadata !{i16 %bytes_out_len}, i64 0, metadata !4343), !dbg !4342 ; [debug line = 122:52] [debug variable = bytes_out_len]
  call fastcc void @"strm_bytes2words<int, (unsigned char)4, false>"(%"class.hls::stream.0.25"* %dwordstrm_in, %"class.hls::stream.24"* %strm_in, i16 zeroext %strm_len), !dbg !4344 ; [debug line = 124:4]
  call fastcc void @decimate_strm(%"class.hls::stream.0.25"* %dwordstrm_out, %"class.hls::stream.0.25"* %dwordstrm_in, i16 zeroext %dwords_in_len), !dbg !4345 ; [debug line = 127:4]
  call fastcc void @"strm_words2bytes<int, (unsigned char)4, false>"(%"class.hls::stream.24"* %strm_out, %"class.hls::stream.0.25"* %dwordstrm_out, i16 zeroext %bytes_out_len), !dbg !4346 ; [debug line = 129:4]
  ret void, !dbg !4347                            ; [debug line = 131:1]
}
...
!4065 = metadata !{void (%"class.hls::stream.24"*, %"class.hls::stream.24"*, i16)* @bytestrm_dwordproc, metadata !4066, metadata !4067, metadata !4068, metadata !4069, metadata !4070, metadata !4071}
...
!4072 = metadata !{void (%"class.hls::stream.24"*, %"class.hls::stream.0.25"*, i16)* @"strm_words2bytes<int, (unsigned char)4, false>", metadata !4066, metadata !4067, metadata !4073, metadata !4069, metadata !4074, metadata !4071}
...
!4121 = metadata !{void (%"class.hls::stream.0.25"*, %"class.hls::stream.24"*, i16)* @"strm_bytes2words<int, (unsigned char)4, false>", metadata !4066, metadata !4067, metadata !4122, metadata !4069, metadata !4123, metadata !4071}
...
!4135 = metadata !{void (%"class.hls::stream.0.25"*, %"class.hls::stream.0.25"*, i16)* @decimate_strm, metadata !4066, metadata !4067, metadata !4136, metadata !4069, metadata !4070, metadata !4071}
...
!4139 = metadata !{i32 786689, metadata !959, metadata !"bytes_out", metadata !960, i32 16777350, metadata !905, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4140 = metadata !{i32 134, i32 29, metadata !959, null}
!4141 = metadata !{i32 786689, metadata !959, metadata !"words_in", metadata !960, i32 33554567, metadata !963, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4142 = metadata !{i32 135, i32 23, metadata !959, null}
!4143 = metadata !{i32 786689, metadata !959, metadata !"bytestrm_len", metadata !960, i32 50331784, metadata !958, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4144 = metadata !{i32 136, i32 16, metadata !959, null}
!4145 = metadata !{i32 125, i32 9, metadata !4146, metadata !4147}
!4146 = metadata !{i32 786443, metadata !2333, i32 123, i32 73, metadata !908, i32 34} ; [ DW_TAG_lexical_block ]
!4147 = metadata !{i32 146, i32 10, metadata !4148, null}
!4148 = metadata !{i32 786443, metadata !4149, i32 145, i32 18, metadata !960, i32 4} ; [ DW_TAG_lexical_block ]
!4149 = metadata !{i32 786443, metadata !4150, i32 143, i32 48, metadata !960, i32 3} ; [ DW_TAG_lexical_block ]
!4150 = metadata !{i32 786443, metadata !4151, i32 143, i32 4, metadata !960, i32 2} ; [ DW_TAG_lexical_block ]
!4151 = metadata !{i32 786443, metadata !959, i32 138, i32 1, metadata !960, i32 1} ; [ DW_TAG_lexical_block ]
!4152 = metadata !{i32 146, i32 9, metadata !4153, metadata !4154}
!4153 = metadata !{i32 786443, metadata !1015, i32 144, i32 79, metadata !908, i32 6} ; [ DW_TAG_lexical_block ]
!4154 = metadata !{i32 156, i32 7, metadata !4149, null}
!4155 = metadata !{i32 143, i32 18, metadata !4150, null}
!4156 = metadata !{i32 143, i32 49, metadata !4149, null}
!4157 = metadata !{i32 144, i32 1, metadata !4149, null}
!4158 = metadata !{i32 145, i32 2, metadata !4149, null}
!4159 = metadata !{i32 786689, metadata !2333, metadata !"this", metadata !908, i32 16777339, metadata !4160, i32 64, i32 0} ; [ DW_TAG_arg_variable ]
!4160 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 64, i64 64, i64 0, i32 0, metadata !964} ; [ DW_TAG_pointer_type ]
!4161 = metadata !{i32 123, i32 48, metadata !2333, metadata !4147}
!4162 = metadata !{i32 786688, metadata !4146, metadata !"tmp", metadata !908, i32 124, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4163 = metadata !{i32 124, i32 22, metadata !4146, metadata !4147}
!4164 = metadata !{i32 126, i32 9, metadata !4146, metadata !4147}
!4165 = metadata !{i32 786688, metadata !4151, metadata !"inval", metadata !960, i32 139, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4166 = metadata !{i32 786689, metadata !2246, metadata !"val", metadata !2247, i32 33554682, metadata !56, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4167 = metadata !{i32 250, i32 55, metadata !2246, metadata !4168}
!4168 = metadata !{i32 147, i32 10, metadata !4148, null}
!4169 = metadata !{i32 786689, metadata !2330, metadata !"val", metadata !2247, i32 33554682, metadata !56, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4170 = metadata !{i32 250, i32 55, metadata !2330, metadata !4171}
!4171 = metadata !{i32 250, i32 77, metadata !2246, metadata !4168}
!4172 = metadata !{i32 790529, metadata !4173, metadata !"tmpword.V", null, i32 140, metadata !4174, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!4173 = metadata !{i32 786688, metadata !4151, metadata !"tmpword", metadata !960, i32 140, metadata !2251, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4174 = metadata !{i32 786438, null, metadata !"ap_uint<32>", metadata !2247, i32 180, i64 32, i64 32, i32 0, i32 0, null, metadata !4175, i32 0, null, metadata !2329} ; [ DW_TAG_class_field_type ]
!4175 = metadata !{metadata !4176}
!4176 = metadata !{i32 786438, null, metadata !"ap_int_base<32, false, true>", metadata !891, i32 1397, i64 32, i64 32, i32 0, i32 0, null, metadata !4177, i32 0, null, metadata !2212} ; [ DW_TAG_class_field_type ]
!4177 = metadata !{metadata !4178}
!4178 = metadata !{i32 786438, null, metadata !"ssdm_int<32 + 1024 * 0, false>", metadata !1024, i32 34, i64 32, i64 32, i32 0, i32 0, null, metadata !4179, i32 0, null, metadata !1037} ; [ DW_TAG_class_field_type ]
!4179 = metadata !{metadata !1026}
!4180 = metadata !{i32 277, i32 10, metadata !4181, metadata !4168}
!4181 = metadata !{i32 786443, metadata !2332, i32 276, i32 92, metadata !2247, i32 33} ; [ DW_TAG_lexical_block ]
!4182 = metadata !{i32 148, i32 7, metadata !4148, null}
!4183 = metadata !{i32 150, i32 28, metadata !4184, null}
!4184 = metadata !{i32 786443, metadata !4149, i32 149, i32 16, metadata !960, i32 5} ; [ DW_TAG_lexical_block ]
!4185 = metadata !{i32 786688, metadata !4151, metadata !"tmpbyte", metadata !960, i32 141, metadata !4186, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4186 = metadata !{i32 786454, null, metadata !"uint8_t", metadata !960, i32 48, i64 0, i64 0, i64 0, i32 0, metadata !911} ; [ DW_TAG_typedef ]
!4187 = metadata !{i32 1959, i32 21, metadata !4188, metadata !4189}
!4188 = metadata !{i32 786443, metadata !2217, i32 1958, i32 110, metadata !891, i32 12} ; [ DW_TAG_lexical_block ]
!4189 = metadata !{i32 1955, i32 16, metadata !4190, metadata !4191}
!4190 = metadata !{i32 786443, metadata !2216, i32 1948, i32 109, metadata !891, i32 10} ; [ DW_TAG_lexical_block ]
!4191 = metadata !{i32 3526, i32 0, metadata !4192, metadata !4193}
!4192 = metadata !{i32 786443, metadata !1016, i32 3526, i32 7873, metadata !891, i32 7} ; [ DW_TAG_lexical_block ]
!4193 = metadata !{i32 151, i32 10, metadata !4184, null}
!4194 = metadata !{i32 1951, i32 9, metadata !4190, metadata !4191}
!4195 = metadata !{i32 786689, metadata !1015, metadata !"this", metadata !908, i32 16777360, metadata !4196, i32 64, i32 0} ; [ DW_TAG_arg_variable ]
!4196 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 64, i64 64, i64 0, i32 0, metadata !906} ; [ DW_TAG_pointer_type ]
!4197 = metadata !{i32 144, i32 48, metadata !1015, metadata !4154}
!4198 = metadata !{i32 786688, metadata !4153, metadata !"tmp", metadata !908, i32 145, metadata !911, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4199 = metadata !{i32 145, i32 22, metadata !4153, metadata !4154}
!4200 = metadata !{i32 145, i32 31, metadata !4153, metadata !4154}
!4201 = metadata !{i32 157, i32 4, metadata !4149, null}
!4202 = metadata !{i32 143, i32 43, metadata !4150, null}
!4203 = metadata !{i32 786688, metadata !4150, metadata !"i", metadata !960, i32 143, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4204 = metadata !{i32 158, i32 1, metadata !4151, null}
!4205 = metadata !{i32 786689, metadata !2336, metadata !"words_out", metadata !960, i32 16777324, metadata !963, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4206 = metadata !{i32 108, i32 23, metadata !2336, null}
!4207 = metadata !{i32 786689, metadata !2336, metadata !"bytes_in", metadata !960, i32 33554541, metadata !905, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4208 = metadata !{i32 109, i32 29, metadata !2336, null}
!4209 = metadata !{i32 786689, metadata !2336, metadata !"bytestrm_len", metadata !960, i32 50331758, metadata !958, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4210 = metadata !{i32 110, i32 16, metadata !2336, null}
!4211 = metadata !{i32 125, i32 9, metadata !4212, metadata !4213}
!4212 = metadata !{i32 786443, metadata !2355, i32 123, i32 73, metadata !908, i32 46} ; [ DW_TAG_lexical_block ]
!4213 = metadata !{i32 118, i32 2, metadata !4214, null}
!4214 = metadata !{i32 786443, metadata !4215, i32 116, i32 48, metadata !960, i32 38} ; [ DW_TAG_lexical_block ]
!4215 = metadata !{i32 786443, metadata !4216, i32 116, i32 4, metadata !960, i32 37} ; [ DW_TAG_lexical_block ]
!4216 = metadata !{i32 786443, metadata !2336, i32 112, i32 1, metadata !960, i32 36} ; [ DW_TAG_lexical_block ]
!4217 = metadata !{i32 146, i32 9, metadata !4218, metadata !4219}
!4218 = metadata !{i32 786443, metadata !2339, i32 144, i32 79, metadata !908, i32 40} ; [ DW_TAG_lexical_block ]
!4219 = metadata !{i32 126, i32 28, metadata !4214, null}
!4220 = metadata !{i32 116, i32 18, metadata !4215, null}
!4221 = metadata !{i32 3526, i32 0, metadata !4222, metadata !4223}
!4222 = metadata !{i32 786443, metadata !2346, i32 3526, i32 3303, metadata !891, i32 43} ; [ DW_TAG_lexical_block ]
!4223 = metadata !{i32 120, i32 21, metadata !4224, null}
!4224 = metadata !{i32 786443, metadata !4214, i32 119, i32 16, metadata !960, i32 39} ; [ DW_TAG_lexical_block ]
!4225 = metadata !{i32 116, i32 49, metadata !4214, null}
!4226 = metadata !{i32 117, i32 1, metadata !4214, null}
!4227 = metadata !{i32 786689, metadata !2355, metadata !"this", metadata !908, i32 16777339, metadata !4196, i32 64, i32 0} ; [ DW_TAG_arg_variable ]
!4228 = metadata !{i32 123, i32 48, metadata !2355, metadata !4213}
!4229 = metadata !{i32 786688, metadata !4212, metadata !"tmp", metadata !908, i32 124, metadata !911, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4230 = metadata !{i32 124, i32 22, metadata !4212, metadata !4213}
!4231 = metadata !{i32 126, i32 9, metadata !4212, metadata !4213}
!4232 = metadata !{i32 786688, metadata !4216, metadata !"tmpbyte", metadata !960, i32 114, metadata !4186, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4233 = metadata !{i32 790529, metadata !4234, metadata !"r.V", null, i32 3526, metadata !4176, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!4234 = metadata !{i32 786688, metadata !4222, metadata !"r", metadata !891, i32 3526, metadata !1019, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4235 = metadata !{i32 786689, metadata !2340, metadata !"val", metadata !2247, i32 33554679, metadata !911, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4236 = metadata !{i32 247, i32 65, metadata !2340, metadata !4237}
!4237 = metadata !{i32 121, i32 14, metadata !4224, null}
!4238 = metadata !{i32 786689, metadata !2341, metadata !"val", metadata !2247, i32 33554679, metadata !911, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4239 = metadata !{i32 247, i32 65, metadata !2341, metadata !4240}
!4240 = metadata !{i32 247, i32 87, metadata !2340, metadata !4237}
!4241 = metadata !{i32 247, i32 72, metadata !4242, metadata !4240}
!4242 = metadata !{i32 786443, metadata !2341, i32 247, i32 70, metadata !2247, i32 41} ; [ DW_TAG_lexical_block ]
!4243 = metadata !{i32 3526, i32 0, metadata !4244, metadata !4237}
!4244 = metadata !{i32 786443, metadata !2342, i32 3526, i32 3019, metadata !891, i32 42} ; [ DW_TAG_lexical_block ]
!4245 = metadata !{i32 790529, metadata !4246, metadata !"r.V", null, i32 3526, metadata !4176, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!4246 = metadata !{i32 786688, metadata !4244, metadata !"r", metadata !891, i32 3526, metadata !1019, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4247 = metadata !{i32 790529, metadata !4248, metadata !"lhs.V", null, i32 3375, metadata !4176, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!4248 = metadata !{i32 786688, metadata !4249, metadata !"lhs", metadata !891, i32 3375, metadata !2350, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4249 = metadata !{i32 786443, metadata !2347, i32 3375, i32 260, metadata !891, i32 44} ; [ DW_TAG_lexical_block ]
!4250 = metadata !{i32 3375, i32 0, metadata !4249, metadata !4237}
!4251 = metadata !{i32 790529, metadata !4252, metadata !"rhs.V", null, i32 3375, metadata !4176, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!4252 = metadata !{i32 786688, metadata !4249, metadata !"rhs", metadata !891, i32 3375, metadata !2350, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4253 = metadata !{i32 790529, metadata !4254, metadata !"r.V", null, i32 3375, metadata !4176, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!4254 = metadata !{i32 786688, metadata !4249, metadata !"r", metadata !891, i32 3375, metadata !4255, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4255 = metadata !{i32 786448, null, null, null, i32 0, i64 0, i64 0, i64 0, i32 0, metadata !2350} ; [ DW_TAG_reference_type ]
!4256 = metadata !{i32 790529, metadata !4257, metadata !"tmpword.V", null, i32 113, metadata !4174, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!4257 = metadata !{i32 786688, metadata !4216, metadata !"tmpword", metadata !960, i32 113, metadata !2251, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4258 = metadata !{i32 277, i32 10, metadata !4181, metadata !4237}
!4259 = metadata !{i32 125, i32 7, metadata !4214, null}
!4260 = metadata !{i32 786689, metadata !2339, metadata !"this", metadata !908, i32 16777360, metadata !4160, i32 64, i32 0} ; [ DW_TAG_arg_variable ]
!4261 = metadata !{i32 144, i32 48, metadata !2339, metadata !4219}
!4262 = metadata !{i32 786688, metadata !4218, metadata !"tmp", metadata !908, i32 145, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4263 = metadata !{i32 145, i32 22, metadata !4218, metadata !4219}
!4264 = metadata !{i32 145, i32 31, metadata !4218, metadata !4219}
!4265 = metadata !{i32 127, i32 4, metadata !4214, null}
!4266 = metadata !{i32 116, i32 43, metadata !4215, null}
!4267 = metadata !{i32 786688, metadata !4215, metadata !"i", metadata !960, i32 116, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4268 = metadata !{i32 128, i32 1, metadata !4216, null}
!4269 = metadata !{i32 786689, metadata !2358, metadata !"strm_out", metadata !902, i32 16777351, metadata !963, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4270 = metadata !{i32 135, i32 24, metadata !2358, null}
!4271 = metadata !{i32 786689, metadata !2358, metadata !"strm_in", metadata !902, i32 33554568, metadata !963, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4272 = metadata !{i32 136, i32 24, metadata !2358, null}
!4273 = metadata !{i32 786689, metadata !2358, metadata !"strm_len", metadata !902, i32 50331785, metadata !958, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4274 = metadata !{i32 137, i32 16, metadata !2358, null}
!4275 = metadata !{i32 143, i32 9, metadata !4276, null}
!4276 = metadata !{i32 786443, metadata !4277, i32 143, i32 4, metadata !902, i32 49} ; [ DW_TAG_lexical_block ]
!4277 = metadata !{i32 786443, metadata !2358, i32 138, i32 1, metadata !902, i32 48} ; [ DW_TAG_lexical_block ]
!4278 = metadata !{i32 131, i32 9, metadata !4279, metadata !4280}
!4279 = metadata !{i32 786443, metadata !2362, i32 129, i32 63, metadata !908, i32 54} ; [ DW_TAG_lexical_block ]
!4280 = metadata !{i32 149, i32 9, metadata !4281, null}
!4281 = metadata !{i32 786443, metadata !4282, i32 147, i32 31, metadata !902, i32 52} ; [ DW_TAG_lexical_block ]
!4282 = metadata !{i32 786443, metadata !4283, i32 147, i32 7, metadata !902, i32 51} ; [ DW_TAG_lexical_block ]
!4283 = metadata !{i32 786443, metadata !4276, i32 143, i32 39, metadata !902, i32 50} ; [ DW_TAG_lexical_block ]
!4284 = metadata !{i32 146, i32 9, metadata !4218, metadata !4285}
!4285 = metadata !{i32 106, i32 9, metadata !4286, metadata !4287}
!4286 = metadata !{i32 786443, metadata !2361, i32 105, i32 88, metadata !908, i32 53} ; [ DW_TAG_lexical_block ]
!4287 = metadata !{i32 153, i32 13, metadata !4281, null}
!4288 = metadata !{i32 143, i32 40, metadata !4283, null}
!4289 = metadata !{i32 144, i32 1, metadata !4283, null}
!4290 = metadata !{i32 147, i32 12, metadata !4282, null}
!4291 = metadata !{i32 147, i32 32, metadata !4281, null}
!4292 = metadata !{i32 148, i32 1, metadata !4281, null}
!4293 = metadata !{i32 786689, metadata !2362, metadata !"this", metadata !908, i32 16777345, metadata !4160, i32 64, i32 0} ; [ DW_TAG_arg_variable ]
!4294 = metadata !{i32 129, i32 56, metadata !2362, metadata !4280}
!4295 = metadata !{i32 786688, metadata !4279, metadata !"tmp", metadata !908, i32 130, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4296 = metadata !{i32 130, i32 22, metadata !4279, metadata !4280}
!4297 = metadata !{i32 132, i32 9, metadata !4279, metadata !4280}
!4298 = metadata !{i32 786688, metadata !4277, metadata !"acc", metadata !902, i32 140, metadata !4299, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4299 = metadata !{i32 786454, null, metadata !"int64_t", metadata !902, i32 40, i64 0, i64 0, i64 0, i32 0, metadata !64} ; [ DW_TAG_typedef ]
!4300 = metadata !{i32 152, i32 10, metadata !4281, null}
!4301 = metadata !{i32 786689, metadata !2361, metadata !"this", metadata !908, i32 16777321, metadata !4160, i32 64, i32 0} ; [ DW_TAG_arg_variable ]
!4302 = metadata !{i32 105, i32 48, metadata !2361, metadata !4287}
!4303 = metadata !{i32 144, i32 48, metadata !2339, metadata !4285}
!4304 = metadata !{i32 145, i32 22, metadata !4218, metadata !4285}
!4305 = metadata !{i32 145, i32 31, metadata !4218, metadata !4285}
!4306 = metadata !{i32 154, i32 7, metadata !4281, null}
!4307 = metadata !{i32 147, i32 26, metadata !4282, null}
!4308 = metadata !{i32 786688, metadata !4277, metadata !"j", metadata !902, i32 139, metadata !955, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4309 = metadata !{i32 155, i32 4, metadata !4283, null}
!4310 = metadata !{i32 143, i32 34, metadata !4276, null}
!4311 = metadata !{i32 786688, metadata !4277, metadata !"i", metadata !902, i32 139, metadata !955, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4312 = metadata !{i32 156, i32 1, metadata !4277, null}
!4313 = metadata !{i32 786689, metadata !901, metadata !"strm_out", metadata !902, i32 16777319, metadata !905, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4314 = metadata !{i32 103, i32 29, metadata !901, null}
!4315 = metadata !{i32 786689, metadata !901, metadata !"strm_in", metadata !902, i32 33554536, metadata !905, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4316 = metadata !{i32 104, i32 29, metadata !901, null}
!4317 = metadata !{i32 786689, metadata !901, metadata !"strm_len", metadata !902, i32 50331753, metadata !958, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4318 = metadata !{i32 105, i32 16, metadata !901, null}
!4319 = metadata !{i32 109, i32 1, metadata !4320, null}
!4320 = metadata !{i32 786443, metadata !901, i32 107, i32 1, metadata !902, i32 0} ; [ DW_TAG_lexical_block ]
!4321 = metadata !{i32 110, i32 1, metadata !4320, null}
!4322 = metadata !{i32 786688, metadata !4320, metadata !"dwordstrm_in", metadata !902, i32 113, metadata !964, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4323 = metadata !{i32 113, i32 20, metadata !4320, null}
!4324 = metadata !{i32 786689, metadata !2356, metadata !"this", metadata !908, i32 16777299, metadata !4160, i32 64, i32 0} ; [ DW_TAG_arg_variable ]
!4325 = metadata !{i32 83, i32 43, metadata !2356, metadata !4326}
!4326 = metadata !{i32 113, i32 32, metadata !4320, null}
!4327 = metadata !{i32 786689, metadata !2357, metadata !"this", metadata !908, i32 16777299, metadata !4160, i32 64, i32 0} ; [ DW_TAG_arg_variable ]
!4328 = metadata !{i32 83, i32 43, metadata !2357, metadata !4329}
!4329 = metadata !{i32 84, i32 5, metadata !2356, metadata !4326}
!4330 = metadata !{i32 786688, metadata !4320, metadata !"dwordstrm_out", metadata !902, i32 114, metadata !964, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4331 = metadata !{i32 114, i32 20, metadata !4320, null}
!4332 = metadata !{i32 83, i32 43, metadata !2356, metadata !4333}
!4333 = metadata !{i32 114, i32 33, metadata !4320, null}
!4334 = metadata !{i32 83, i32 43, metadata !2357, metadata !4335}
!4335 = metadata !{i32 84, i32 5, metadata !2356, metadata !4333}
!4336 = metadata !{i32 115, i32 1, metadata !4320, null}
!4337 = metadata !{i32 117, i32 1, metadata !4320, null}
!4338 = metadata !{i32 786688, metadata !4320, metadata !"bytes_in_len", metadata !902, i32 120, metadata !958, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4339 = metadata !{i32 120, i32 36, metadata !4320, null}
!4340 = metadata !{i32 121, i32 41, metadata !4320, null}
!4341 = metadata !{i32 786688, metadata !4320, metadata !"dwords_in_len", metadata !902, i32 121, metadata !958, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4342 = metadata !{i32 122, i32 52, metadata !4320, null}
!4343 = metadata !{i32 786688, metadata !4320, metadata !"bytes_out_len", metadata !902, i32 122, metadata !958, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4344 = metadata !{i32 124, i32 4, metadata !4320, null}
!4345 = metadata !{i32 127, i32 4, metadata !4320, null}
!4346 = metadata !{i32 129, i32 4, metadata !4320, null}
!4347 = metadata !{i32 131, i32 1, metadata !4320, null}
